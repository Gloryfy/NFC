...
/** \file
* Internal definitions for Ncx3330 specific HAL-Component of Reader Library Framework.
*
* $Author$
* $Revision$ (v05.22.00)
* $Date$
...
#ifndef PHHALHW_NCx3330_INT_H
#define PHHALHW_NCx3330_INT_H

#include <ph_Status.h>
#include <phhalHw.h>

/** \defgroup phhalHw_NCx3330_Int Internal
* \brief Ncx3330 Int functions
* @{
*/
...
/* Timer config */
#define TIMER_FREQ                              13.56               /**< Ncx3330 clk frequency.*/
...
#define PHHAL_HW_NCx3330_MAX_FREQ                13560000U            /**< Ncx3330 clk Maximum frequency = 13.56 MHz.*/
#define PHHAL_HW_NCx3330_MIN_FREQ                53000U               /**< Ncx3330 clk Minimum frequency = 53 KHz.*/
#define PHHAL_HW_NCx3330_MAX_TIME_DELAY_MS       19784U               /**< Ncx3330 Maximum Time Delay in milli second = 19.78443396226.*/
#define PHHAL_HW_NCx3330_MIN_TIME_DELAY_US       1U                   /**< Ncx3330 Minimum Time Delay in micro second = 0.00001886792.*/
#define PHHAL_HW_NCx3330_CONVERSION_MS_SEC       1000U                /**< MilliSec to Sec (In denominator for calculation purpose) --> 1000.*/
#define PHHAL_HW_NCx3330_CONVERSION_US_SEC       1000000U             /**< MicroSec to Sec (In denominator for calculation purpose) --> 1000000.*/


#define PHHAL_HW_NCx3330_I14443_ADD_DELAY_US     15U                  /**< Additional digital timeout delay for ISO14443. */
#define PHHAL_HW_NCx3330_I15693_ADD_DELAY_US     120U                 /**< Additional digital timeout delay for ISO15693. */
/**
...
*/
/*@{*/
#define  PHHAL_HW_NCx3330_MAX_FSD     256U
/*@}*/
...
phStatus_t phhalHw_Ncx3330_GetRxBuffer(
    phhalHw_Ncx3330_DataParams_t * pDataParams,          /**<[In] DatParams to this layer.*/
...
/**
* \brief NCx3330 implementation of common receive functionality.
* \return Status code
* \retval #PH_ERR_SUCCESS Operation successful.
* \retval Other Depending on implementation and underlying component.
*/
phStatus_t phhalHw_Ncx3330_Receive_Int(
    phhalHw_Ncx3330_DataParams_t * pDataParams,  /**<[In] DatParams to this layer. */
...
/**
* \brief NCx3330 implementation of loading of idle command.
* \return Status code
* \retval #PH_ERR_SUCCESS Operation successful.
* \retval Other Depending on implementation and underlying component.
*/
phStatus_t phhalHw_Ncx3330_Int_IdleCommand(
    phhalHw_Ncx3330_DataParams_t * pDataParams /**<[In] DatParams to this layer. */
    );

/**
* \brief NCx3330 implementation of loading a command.
* \return Status code
* \retval #PH_ERR_SUCCESS Operation successful.
* \retval Other Depending on implementation and underlying component.
*/
phStatus_t phhalHw_Ncx3330_Int_LoadCommand(
    phhalHw_Ncx3330_DataParams_t * pDataParams, /**<[In] DatParams to this layer. */
...
/**
* \brief NCx3330 implementation of handling the F0 Sync byte automatically for P2P data exchange.
* \return Status code
* \retval #PH_ERR_SUCCESS Operation successful.
* \retval Other Depending on implementation and underlying component.
*/
...
/** @}
* end of phhalHw_NCx3330_Int group
*/
#endif  /* PHHALHW_NCx3330_INT_H */
