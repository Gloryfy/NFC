...
/** The maximum allowed FSDI/FSCI value as per ISO and EMVCo v1.0 */
#define PHPAL_I14443P4A_FRAMESIZE_MAX           12U

/** The minimum FSDI value as per EMVCo v1.0 - Requirements 5.9 */
#define PHPAL_I14443P4A_EMVCO_FRAMESIZE_MIN     8U

/* Delta SFGT as per EMVCo v1.0 and NFC Forum Digital Protocol v1.1 */
