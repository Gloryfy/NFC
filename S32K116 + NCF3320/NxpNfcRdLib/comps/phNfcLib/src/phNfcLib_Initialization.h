...
typedef struct
{
    ...
    phhalHw_Ncx3320_DataParams_t         sHal;               /**< HAL component holder */
    #endif /* NXPBUILD__PHHAL_HW_NCx3320 */

    #ifdef NXPBUILD__PHHAL_HW_NCx3330
    phhalHw_Ncx3330_DataParams_t        sHal;               /**< HAL component holder */
    ...
    phKeyStore_Ncx3320_DataParams_t      sKeyStore;          /**< Ncx3320 HW Keystore component holder */
