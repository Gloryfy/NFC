...
* $Revision: 5398 $
* $Date: 2016-07-04 12:51:13 +0530 (Mon, 04 Jul 2016) $
*
* History:
...
//#ifndef NXPBUILD__PHHAL_HW_PN7462AU                         /**< If the used NFC HW is not NFC Controller like PN7462AU, then include one of the front end HAL */
    #define NXPBUILD__PHHAL_HW_PN7462AU
    #define NXPBUILD__PHHAL_HW_NCx3320                      /**< NCx3320 HAL Component is included */
    #define NXPBUILD__PHHAL_HW_NCx3330                       /**< NCx3330 HAL Component is included */
...
#define NXPBUILD__PHPAL_I18092MPI_SW
#define NXPBUILD__PHPAL_I18092MT_SW
...
#if 1 //ndef NXPBUILD__PHHAL_HW_NCx3320                            /**< If FE HAL is NCx3320, then exclude ISO14443 Card Mode PAL & ISO18092 Target Mode PAL, otherwise include as required. */
    #define NXPBUILD__PHPAL_I14443P4MC_SW               /**< PAL ISO 14443-4 Card Mode SW Component is included. */
    #define NXPBUILD__PHPAL_I18092MT_SW                 /**< PAL ISO 18092 Target Mode SW Component is included. */
...
#define NXPBUILD__PHAC_DISCLOOP_SW                          /**< Discovery Loop Activity SW Component is included. */
    ...
    #if 1 //ndef NXPBUILD__PHHAL_HW_NCx3320                               /**< If FE HAL is NCx3320, target mode is not supported at all, hence exclude those SRC, otherwise include as required */
