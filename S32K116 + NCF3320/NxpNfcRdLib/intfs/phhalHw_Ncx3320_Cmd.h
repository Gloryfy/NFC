...
/**
 * Transmitter output amplitude reduction.
 */
#define PH_NFCRDLIB_EXAMPLE_LPCD_CWAMP_SETTING  3
...
\ref phhalHw_Ncx3320_Cmd_Lpcd_SetConfig function before calling \ref phhalHw_Ncx3320_Cmd_Lpcd_GetConfig function.
*/
...
*/
#define PHHAL_HW_NCx3320_CMD_LPCD_MODE_MASK               0x0FU
/*@}*/
...
* \retval Other Depending on implementation and underlying component.
*/
phStatus_t phhalHw_Ncx3320_Cmd_Lpcd_GetConfig(
                                        phhalHw_Ncx3320_DataParams_t * pDataParams,   /**< [In] Pointer to this layer's parameter structure. */
...
*/
phStatus_t phhalHw_Ncx3320_Cmd_Lpcd_SetConfig(
                                            phhalHw_Ncx3320_DataParams_t * pDataParams,    /**< [In] Pointer to this layer's parameter structure. */
...
/**
 * \brief Performs a Advanced_Lpcd_SetConfig.
 *
 * Sets the bMode,I, Q, wPowerDownTimeMs, and wDetectionTimeUs channel values for the current antenna status.
 * This is intended to be used to set the input parameters for LPCD.
 * \return Status code
 * \retval #PH_ERR_SUCCESS Operation successful.
 */
phStatus_t phhalHw_Ncx3320_Cmd_Advanced_Lpcd_SetConfig(phhalHw_Ncx3320_DataParams_t * pDataParams, /**< [In] Pointer to this layer's parameter structure. */
	uint8_t bTxiDelta, /**< [In] Tx iLoad Delta. [0:4] */
	uint8_t bTxiDirection, /**< [In] iLoad is decreased or increased by bTxiDelta [0:1]. */
	uint8_t bTxiChannel /**< [In] Select I or Q-Channel [0:1]. */
);
...
*
* This implements AckReq command of NCx3320. See \ref phhalHw_I18000p3m3Inventory
