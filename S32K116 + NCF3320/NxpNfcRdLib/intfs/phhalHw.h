...
#define PHHAL_HW_NCx3320_CONFIG_LPCD_CWMAX   (PH_CONFIG_CUSTOM_BEGIN+6U)
     ...
     */
#define PHHAL_HW_NCx3320_CONFIG_TX_AMPLITUDE  (PH_CONFIG_CUSTOM_BEGIN+5U)
     ...
     */
#define PHHAL_HW_NCx3320_TX_AMP_TVDD_MINUS_100MV      0x00U

    /**
     * To set Tx Amplitude of Tvdd-250 milli Volt.
     */
#define PHHAL_HW_NCx3320_TX_AMP_TVDD_MINUS_250MV      0x40U

    /**
     * To set Tx Amplitude of Tvdd-500 milli Volt.
     */
#define PHHAL_HW_NCx3320_TX_AMP_TVDD_MINUS_500MV      0x80U

    /**
     * To set Tx Amplitude of Tvdd-1000 milli Volt.
     */
#define PHHAL_HW_NCx3320_TX_AMP_TVDD_MINUS_1000MV     0xC0U
    /*@}*/
...
#define PHHAL_HW_NCx3320_EE_ADDR_EPC_UID              0x01D4U
#define PHHAL_HW_NCx3320_EE_ADDR_I18000P3M3_DSM2      0x01E8U
#define PHHAL_HW_NCx3320_EE_ADDR_I18000P3M3_DSM4      0x0200U
#define PHHAL_HW_NCx3320_EE_ADDR_I18000P3M3_QSM2      0x0214U
#define PHHAL_HW_NCx3320_EE_ADDR_I18000P3M3_QSM4      0x0228U
    /*@}*/
...
#define PHHAL_HW_NCx3320_REG_NUM                      18U
     ...
     */
    /*@{*/
#define PHHAL_HW_NCx3320_RX_REG_NUM                   6U
    /*@}*/
...
#define PHHAL_HW_NCx3320_ARR_LDREG_FILL(EEADDR)                                                           \
    ((uint8_t)((EEADDR) >> PHHAL_HW_NCx3320_REG_EEADDR_HIGH_RS_POS) & PHHAL_HW_NCx3320_REG_EEADDR_HIGH_MASK), \
    ((uint8_t)(EEADDR)),                                                                                \
    ((uint8_t)(PHHAL_HW_NCx3320_REG_ADDR)),                                                               \
    ((uint8_t)(PHHAL_HW_NCx3320_REG_NUM))
    /*@}*/

    extern const uint8_t gkphhalHw_Ncx3320_LoadConfig[];

    /* LPCD Related */
    typedef enum LPCD_CALIB_StateType_tag
    {
    	LPCD_CALIB_START = 0, LPCD_CALIB_CMD_REQ, LPCD_CALIB_CMD_WAITRSP, LPCD_CALIB_FINISH
    } LPCD_CALIB_StateType_t;

    /**
     * \brief LPCD structure to handle Advanced LPCD
     */
    typedef struct
    {
    	LPCD_CALIB_StateType_t bCalib_State;                /**< State for LPCD Nonblocking processing */
    	uint8_t bT4Config;                                  /**< Data For LPCD Nonblocking processing */
    	uint8_t bLpcdIload;                                 /**< Data For LPCD Nonblocking processing */
    	uint8_t bLpcdIndex;                                 /**< Data For LPCD Nonblocking processing */
    	uint8_t bLpcdMatrix[16][3];                         /**< Data For LPCD Nonblocking processing */
    	uint8_t bRxAnaBackup;                               /**< Data For LPCD Nonblocking processing */
    } phhal_LPCD_Handle_t;
    ...
    */
    typedef struct
    {
        ...
        uint16_t wCfgShadow[PHHAL_HW_NCx3320_SHADOW_COUNT];   /**< Configuration shadow; Stores configuration for current card type. */
    	...
    	uint8_t bTxiLoad;                                   /**< Tx-iLoad value in case of no card on antenna. */
    	uint8_t bIDelta;                                    /**< The delta value used when configuring bIMin and bIMax*/
    	uint8_t bQDelta;                                    /**< The delta value used when configuring bQMin and bQMax */
	    ...
	    uint8_t bEmdMode;                                   /**< Enable/Disable to perform EMD error check in discovery loop. */
	    uint8_t bEmdTimeout;                                /**< Timeout threshold for EMD detection algorithm for polling loop. */
	    uint8_t bEmdThreshold;                              /**< Rx Threshold for EMD detection algorithm for polling loop. */
	    uint8_t bEmdReceiveGain;                            /**< Receive Gain for EMD detection algorithm for polling loop. */
        ...
        uint8_t bLpcdOption;                                /**< Lpcd Option only available in NCx3320 Plus */
    	uint8_t bTxiDelta;                                  /**< Set value for bIDelta, bQDelta when I, Q change in both directions*/
    	uint8_t bTxiDirection;                              /**< Select Txi direction: negative or positive */
    	uint8_t bTxiChannel;                                /**< Select Txi channel I or Q*/
    	phhal_LPCD_Handle_t bSmLpcdParams;                  /**< StateMachine For LPCD Nonblocking processing handle */
    	/*phhal_CMD_Handle_t bSmCmdParams; */               /**< StateMachine For HWCommand Nonblocking processing handle */
...
/**
 * \defgroup phhalHw_Ncx3330 component : Ncx3330
 * \brief Ncx3330 HAL component
 *
 * @{
 */
#define PHHAL_HW_NCx3330_ID                          0x0EU        /**< ID for NCx3330 HAL component */
#define PHHAL_HW_NCx3330_DEFAULT_TIMEOUT             150U         /**< Default timeout in microseconds. */
#define PHHAL_HW_NCx3330_DEFAULT_TIMEOUT_MILLI       50U          /**< Default timeout in milliseconds */
#define PHHAL_HW_NCx3330_SHADOW_COUNT                0x10U        /**< Ncx3330 Shadow Register count */
#define INSTR_BUFFER_SIZE                           262U         /**< Used to form commands 259-Max buf size in writeregmultiple */
#define PHHAL_HW_NCx3330_DEFAULT_FELICA_EMD_REGISTER 0x00FF0019U  /**< FeliCa EMD Control register default value */
...
/**
 * NCx3330 HAL component.
 * This structure holds all the data that are required for the NCx3330 HAL
 * operations.
 */
    typedef struct
    {
        ...
        uint16_t wCfgShadow[PHHAL_HW_NCx3330_SHADOW_COUNT];  /**< Configuration shadow; Stores configuration for current cardtype. */
        uint16_t wFirmwareVer;                              /**< Stores firmware version loaded on Ncx3330. */
        ...
        phOsal_EventObj_t HwEventObj;                       /**< Handle for Event. */
    /*end */
    } phhalHw_Ncx3330_DataParams_t;

/**
 * \brief Initializes the NCx3330 HAL component.
...
phStatus_t phhalHw_Ncx3330_Init(
    phhalHw_Ncx3330_DataParams_t * pDataParams,                /**<[In] Pointer to data parameter of this HAL layer */
    uint16_t wSizeOfDataParams,                               /**<[In] Size of the data parameter of the structure that was passed */
    void * pBalDataParams,                                    /**<[In] Pointer to the lower layer parameter(BAL) structure */
    void * pKeyStoreDataParams,                               /**< [In] Pointer to the parameter structure of the keyStore layer. */
...
/**
* \brief NCx3330 implementation of phhalHw_SetListenParameters
*
...
#define PHHAL_HW_CONFIG_RXDATARATE_FRAMING        0x000AU
     ...
     * \li #PHHAL_HW_NCx3320_MODINDEX_EPCUID  \n
     * \li #PHHAL_HW_NCx3320_MODINDEX_I18000P3M3\n
     *
     *
     * */
 ...
 * */
#define PHHAL_HW_CONFIG_EMD_MODE                  0x0062U

/**
 * Set new TIMEOUT_VALUE_MS for checking EMD.
 *
 * */
#define PHHAL_HW_CONFIG_EMD_TIMEOUT               0x0063U
...
#define PHHAL_HW_CONFIG_TIMING_MS                 0x8012U
     ...
     *        NCx3330 FW less than V04.00.
     * */
#define PHHAL_HW_NCx3330_CONFIG_SET_FELICA_EMD                        0x8025U

    /**
     * Enable (#PH_ON) or Disable (#PH_OFF) FeliCa EMD Length check based
     * on Maximum and Minimum Length configuration using \ref PHHAL_HW_NCx3330_CONFIG_SET_FELICA_EMD_LEN_BYTE_MAX
     * and \ref PHHAL_HW_NCx3330_CONFIG_SET_FELICA_EMD_LEN_BYTE_MIN respectively.\n
     *
     * Note: FeliCa EMD is available from FW V04.01 and these configurations shall not be used with
     *       NCx3330 FW less than V04.00.
     * */
#define PHHAL_HW_NCx3330_CONFIG_SET_FELICA_EMD_LEN_CHECK              0x8026U

    /**
     * Enable (#PH_ON) or Disable (#PH_OFF) FeliCa EMD Response Code check based
     * on Response code that can be configured using \ref PHHAL_HW_NCx3330_CONFIG_SET_FELICA_EMD_RC_BYTE_VAL.\n
     *
     * Note: FeliCa EMD is available from FW V04.01 and these configurations shall not be used with
     *       NCx3330 FW less than V04.00.
     * */
#define PHHAL_HW_NCx3330_CONFIG_SET_FELICA_EMD_RC_CHECK               0x8027U
     ...
     *       NCx3330 FW less than V04.00.
     * */
#define PHHAL_HW_NCx3330_CONFIG_SET_FELICA_EMD_PROTOCOL_ERR_CHECK     0x8028U
     ...
     *       NCx3330 FW less than V04.00.
     * */
#define PHHAL_HW_NCx3330_CONFIG_SET_FELICA_EMD_INTEGRITY_ERR_CHECK    0x8029U
     ...
     *       NCx3330 FW less than V04.00.
     * */
#define PHHAL_HW_NCx3330_CONFIG_SET_FELICA_EMD_LEN_BYTE_MIN           0x802AU
     ...
     *       NCx3330 FW less than V04.00.
     * */
#define PHHAL_HW_NCx3330_CONFIG_SET_FELICA_EMD_LEN_BYTE_MAX           0x802BU
     ...
     *       NCx3330 FW version less than V04.1.
     * */
#define PHHAL_HW_NCx3330_CONFIG_SET_FELICA_EMD_RC_BYTE_VAL            0x802CU
     ...
     * parameters + data to the FIFO. Pn512(Pn512) and Ncx3320 HALs provide such a functionality.\n
     *
     * */
...
#define PHHAL_HW_CONFIG_BAL_CONNECTION            0x8040U
    ...
    /**
     * Bit rate for serial UART communication for Pn512, NCx3320\n
...
{
#ifdef NXPBUILD__PHHAL_HW_NCx3320
    phhalHw_Ncx3320_DataParams_t         sHal;                       /* HAL component holder for Ncx3320 */
#endif /* NXPBUILD__PHHAL_HW_NCx3320*/
#ifdef NXPBUILD__PHHAL_HW_PN7462AU
    phhalHw_PN7462AU_DataParams_t      sHal;                       /* HAL component holder for PN7462AU */
#endif /* NXPBUILD__PHHAL_HW_PN7462AU */
#ifdef NXPBUILD__PHHAL_HW_NCx3330
    phhalHw_Ncx3330_DataParams_t        sHal;                       /* HAL component holder for Ncx3330 */
#endif /* NXPBUILD__PHHAL_HW_NCx3330*/
...
#define phhalHw_Transmit(pDataParams, wOption, pTxBuffer, wTxLength) \
        phhalHw_Ncx3320_Transmit((phhalHw_Ncx3320_DataParams_t *)pDataParams, wOption, pTxBuffer, wTxLength)

#define phhalHw_Receive(pDataParams, wOption, ppRxBuffer, pRxLength) \
        phhalHw_Ncx3320_Receive((phhalHw_Ncx3320_DataParams_t *)pDataParams, wOption, ppRxBuffer, pRxLength)
...
#define phhalHw_AsyncAbort(pDataParams) \
        phhalHw_Ncx3320_AsyncAbort((phhalHw_Ncx3320_DataParams_t *)pDataParams)
...
#define phhalHw_I18000p3m3Inventory(pDataParams, pSelCmd, bSelCmdLen, bNumValidBitsinLastByte, pBeginRndCmd, bTSprocessing, ppRxBuffer, wRxBufferLen)\
        phhalHw_Ncx3320_I18000p3m3Inventory((phhalHw_Ncx3320_DataParams_t *)pDataParams, pSelCmd, bSelCmdLen, bNumValidBitsinLastByte, pBeginRndCmd, bTSprocessing, ppRxBuffer, wRxBufferLen)

#define phhalHw_I18000p3m3ResumeInventory(pDataParams, ppRxBuffer, wRxBufferLen)\
         phhalHw_Ncx3320_I18000p3m3ResumeInventory((phhalHw_Ncx3320_DataParams_t *)pDataParams, ppRxBuffer, wRxBufferLen)
...
#define phhalHw_EventWait(pDataParams, dwEventTimeout)  \
    phhalHw_Ncx3320_EventWait((phhalHw_Ncx3320_DataParams_t *)pDataParams, dwEventTimeout)

#define  phhalHw_EventConsume(pDataParams)  \
         phhalHw_Ncx3320_EventConsume((phhalHw_Ncx3320_DataParams_t *) pDataParams)
#endif

#if defined  (NXPRDLIB_REM_GEN_INTFS) && \
    defined (NXPBUILD__PHHAL_HW_PN512)
#include "../comps/phhalHw/src/Pn512/phhalHw_Pn512.h"

#define phhalHw_Exchange(pDataParams,wOption,pTxBuffer,wTxLength,ppRxBuffer,pRxLength) \
        phhalHw_Pn512_Exchange((phhalHw_Pn512_DataParams_t *)pDataParams, wOption, pTxBuffer, wTxLength, ppRxBuffer, pRxLength)

#define phhalHw_ApplyProtocolSettings(pDataParams, bMode) \
        phhalHw_Pn512_ApplyProtocolSettings((phhalHw_Pn512_DataParams_t *)pDataParams, bMode)

#define phhalHw_SetConfig(pDataParams, wConfig, wValue) \
        phhalHw_Pn512_SetConfig((phhalHw_Pn512_DataParams_t *)pDataParams, wConfig, wValue)

#define phhalHw_MfcAuthenticateKeyNo(pDataParams, bBlockNo, bKeyType, wKeyNo, wKeyVersion,pUid) \
        phhalHw_Pn512_MfcAuthenticateKeyNo((phhalHw_Pn512_DataParams_t *)pDataParams,bBlockNo, bKeyType, wKeyNo, wKeyVersion, pUid)

#define phhalHw_MfcAuthenticate(  pDataParams, bBlockNo, bKeyType, pKey, pUid) \
        phhalHw_Pn512_MfcAuthenticate((phhalHw_Pn512_DataParams_t *)pDataParams,bBlockNo,bKeyType, pKey,pUid)

#define phhalHw_GetConfig(pDataParams, wConfig, pValue) \
        phhalHw_Pn512_GetConfig((phhalHw_Pn512_DataParams_t *)pDataParams, wConfig, pValue)

#define phhalHw_FieldOn(pDataParams) \
        phhalHw_Pn512_FieldOn((phhalHw_Pn512_DataParams_t *)pDataParams)

#define phhalHw_FieldOff(pDataParams) \
        phhalHw_Pn512_FieldOff((phhalHw_Pn512_DataParams_t *)pDataParams)

#define phhalHw_FieldReset(pDataParams) \
        phhalHw_Pn512_FieldReset((phhalHw_Pn512_DataParams_t *)pDataParams)

#define phhalHw_Wait(pDataParams, bUnit, wTimeout) \
        phhalHw_Pn512_Wait((phhalHw_Pn512_DataParams_t *)pDataParams, bUnit, wTimeout)

#define phhalHw_Transmit(pDataParams, wOption, pTxBuffer, wTxLength) \
        phhalHw_Pn512_Transmit((phhalHw_Pn512_DataParams_t *)pDataParams, wOption, pTxBuffer, wTxLength)

#define phhalHw_Receive(pDataParams, wOption, ppRxBuffer, pRxLength) \
        phhalHw_Pn512_Receive((phhalHw_Pn512_DataParams_t *)pDataParams, wOption, ppRxBuffer, pRxLength)

#define phhalHw_Autocoll(pDataParams, wMode, ppRxBuffer, pRxLength, pProtParams) \
        phhalHw_Pn512_Autocoll((phhalHw_Pn512_DataParams_t *)pDataParams, wMode, ppRxBuffer, pRxLength, pProtParams);

#define phhalHw_AsyncAbort(pDataParams) \
        phhalHw_Pn512_AsyncAbort((phhalHw_Pn512_DataParams_t *)pDataParams)

#define phhalHw_Lpcd(pDataParams) PH_ADD_COMPCODE_FIXED(PH_ERR_UNSUPPORTED_PARAMETER, PH_COMP_HAL)

#define phhalHw_DeInit(pDataParams) \
         phhalHw_Pn512_DeInit((phhalHw_Pn512_DataParams_t *)pDataParams)

#define phhalHw_EventWait(pDataParams, dwEventTimeout)  \
        phhalHw_Pn512_EventWait((phhalHw_Pn512_DataParams_t *)pDataParams, dwEventTimeout)

#define  phhalHw_EventConsume(pDataParams)  \
         phhalHw_Pn512_EventConsume((phhalHw_Pn512_DataParams_t *) pDataParams)
#endif
...
#if defined  (NXPRDLIB_REM_GEN_INTFS) && \
        defined (NXPBUILD__PHHAL_HW_NCx3330)
#include "../comps/phhalHw/src/Ncx3330/phhalHw_Ncx3330.h"

#define phhalHw_Exchange(pDataParams,wOption,pTxBuffer,wTxLength,ppRxBuffer,pRxLength) \
        phhalHw_Ncx3330_Exchange((phhalHw_Ncx3330_DataParams_t *)pDataParams, wOption, pTxBuffer, wTxLength, ppRxBuffer, pRxLength)

#define phhalHw_ApplyProtocolSettings(pDataParams, bMode) \
        phhalHw_Ncx3330_ApplyProtocolSettings((phhalHw_Ncx3330_DataParams_t *)pDataParams, bMode)

#define phhalHw_SetConfig(pDataParams, wConfig, wValue) \
        phhalHw_Ncx3330_SetConfig((phhalHw_Ncx3330_DataParams_t *)pDataParams, wConfig, wValue)

#define phhalHw_MfcAuthenticateKeyNo(pDataParams, bBlockNo, bKeyType, wKeyNo, wKeyVersion,pUid) \
        phhalHw_Ncx3330_MfcAuthenticateKeyNo((phhalHw_Ncx3330_DataParams_t *)pDataParams,bBlockNo, bKeyType, wKeyNo, wKeyVersion, pUid)

#define phhalHw_MfcAuthenticate(  pDataParams, bBlockNo, bKeyType, pKey, pUid) \
        phhalHw_Ncx3330_MfcAuthenticate((phhalHw_Ncx3330_DataParams_t *)pDataParams,bBlockNo,bKeyType, pKey,pUid)

#define phhalHw_GetConfig(pDataParams, wConfig, pValue) \
        phhalHw_Ncx3330_GetConfig((phhalHw_Ncx3330_DataParams_t *)pDataParams, wConfig, pValue)

#define phhalHw_FieldOn(pDataParams) \
        phhalHw_Ncx3330_FieldOn((phhalHw_Ncx3330_DataParams_t *)pDataParams)

#define phhalHw_FieldOff(pDataParams) \
        phhalHw_Ncx3330_FieldOff((phhalHw_Ncx3330_DataParams_t *)pDataParams)

#define phhalHw_FieldReset(pDataParams) \
        phhalHw_Ncx3330_FieldReset((phhalHw_Ncx3330_DataParams_t *)pDataParams)

#define phhalHw_Wait(pDataParams, bUnit, wTimeout) \
        phhalHw_Ncx3330_Wait((phhalHw_Ncx3330_DataParams_t *)pDataParams, bUnit, wTimeout)

#define phhalHw_Transmit(pDataParams, wOption, pTxBuffer, wTxLength) \
        phhalHw_Ncx3330_Transmit((phhalHw_Ncx3330_DataParams_t *)pDataParams, wOption, pTxBuffer, wTxLength)

#define phhalHw_Receive(pDataParams, wOption, ppRxBuffer, pRxLength) \
        phhalHw_Ncx3330_Receive((phhalHw_Ncx3330_DataParams_t *)pDataParams, wOption, ppRxBuffer, pRxLength)

#define phhalHw_Lpcd(pDataParams) \
        phhalHw_Ncx3330_Lpcd((phhalHw_Ncx3330_DataParams_t *)pDataParams)

#define phhalHw_AsyncAbort(pDataParams) \
        phhalHw_Ncx3330_AsyncAbort((phhalHw_Ncx3330_DataParams_t *)pDataParams)

#define phhalHw_Autocoll(pDataParams, wMode, ppRxBuffer, pRxLength, pProtParams) \
        phhalHw_Ncx3330_Autocoll((phhalHw_Ncx3330_DataParams_t *)pDataParams, wMode, ppRxBuffer,  pRxLength, pProtParams)

#define phhalHw_I18000p3m3Inventory(pDataParams, pSelCmd, bSelCmdLen, bNumValidBitsinLastByte, pBeginRndCmd, bTSprocessing, ppRxBuffer, wRxBufferLen)\
        phhalHw_Ncx3330_I18000p3m3Inventory((phhalHw_Ncx3330_DataParams_t *)pDataParams, pSelCmd, bSelCmdLen, bNumValidBitsinLastByte, pBeginRndCmd, bTSprocessing, ppRxBuffer, wRxBufferLen)

#define phhalHw_I18000p3m3ResumeInventory(pDataParams, ppRxBuffer, wRxBufferLen)\
        phhalHw_Ncx3330_18000p3m3ResumeInventory((phhalHw_Ncx3330_DataParams_t *)pDataParams, ppRxBuffer, wRxBufferLen)

#define phhalHw_DeInit(pDataParams) \
        phhalHw_Ncx3330_DeInit((phhalHw_Ncx3330_DataParams_t *)pDataParams)

#define phhalHw_EventWait(pDataParams, dwEventTimeout)  \
        phhalHw_Ncx3330_EventWait((phhalHw_Ncx3330_DataParams_t *)pDataParams, dwEventTimeout)

#define  phhalHw_EventConsume(pDataParams)  \
         phhalHw_Ncx3330_EventConsume((phhalHw_Ncx3330_DataParams_t *) pDataParams)
    ...
    * \li HAL initialization - Example phhalHw_Pn512_Init();
    ...
    * \brief Configure reader IC for a particular reader/initiator protocol.
    *
    * Used to detect external disturber and adjust register settings accordingly.
    * Example:
    *
    *
    * Before this function is called, it is expected that the user/upper layer has performed\n
    ...
    * \li BAL initialization (where applicable) - Example - phbalReg_Serial_Init()
    * \li HAL initialization - Example phhalHw_Pn512_Init();
    * \li HAL specific listen mode configuration - Example phhalHw_Pn512_SetListenParameters(pHal, pSENS_RES, pNfcId1, bSelelctResponse, pFelicaResponse, bNfcId3);
    ...
    * \li HAL specific LPCD configuration - phhalHw_Ncx3320_phhalHw_Ncx3320_Cmd_Lpcd_SetConfig(pHal, bLPCD_MODE, I_Value, Q_Value, wPowerDownTimeMs, wDetectionTimeUs);
