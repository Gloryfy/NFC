...
#if !defined(PH_NXPNFCRDLIB_CONFIG_HAL_TX_BUFFSIZE) && !defined(NXPBUILD__PHHAL_HW_NCx3320)
...
#if !defined(PH_NXPNFCRDLIB_CONFIG_HAL_RX_BUFFSIZE) && !defined(NXPBUILD__PHHAL_HW_NCx3320)
...
#if defined(NXPBUILD__PHHAL_HW_NCx3320) && defined(PH_NXPNFCRDLIB_CONFIG_HIGHER_FSDI)
    #define PH_NXPNFCRDLIB_CONFIG_FSDI_VALUE                     10U      /**< With NCx3320 we can configure the required FSDI value. But as frame error detection with CRC16 is not good beyond 1KBytes Limiting the value to 10. */
    #define PH_NXPNFCRDLIB_CONFIG_FSCI_VALUE                     10U      /**< With NCx3320 we can configure the required FSCI value. But as frame error detection with CRC16 is not good beyond 1KBytes Limiting the value to 10. */
#endif

#ifndef PH_NXPNFCRDLIB_CONFIG_FSDI_VALUE
    #define PH_NXPNFCRDLIB_CONFIG_FSDI_VALUE                     8U       /**< Default FSDI Configuration. This value is fixed for NCx3330 and PN7462AU as these Readers doesn't support frame size. */
#endif /* PH_NXPNFCRDLIB_CONFIG_FSDI_VALUE */

#ifndef PH_NXPNFCRDLIB_CONFIG_FSCI_VALUE
    #define PH_NXPNFCRDLIB_CONFIG_FSCI_VALUE                     PH_NXPNFCRDLIB_CONFIG_DEFAULT_FSCI_VALUE   /**< Default FSCI Configuration. This value is fixed for NCx3330 and PN7462AU as these Readers doesn't support frame size. */
...
*/
/*@{*/
#define PH_NXPNFCRDLIB_CONFIG_NCx3320_PRECACHED_255BYTES           0xFFU    /**< Maximum number of bytes to precache into FIFO before triggering a command for 255 FIFO. */
#define PH_NXPNFCRDLIB_CONFIG_NCx3320_PRECACHED_512BYTES           0x200U   /**< Maximum number of bytes to precache into FIFO before triggering a command for 512 FIFO. */
#define PH_NXPNFCRDLIB_CONFIG_NCx3320_DEFAULT_PRECACHED_BYTES      PH_NXPNFCRDLIB_CONFIG_NCx3320_PRECACHED_255BYTES /**< Default number of bytes to precache into FIFO. */
/*@}*/
