...
#if defined(PHDRIVER_FRDM_S32K116NCx3320_BOARD)
...
#define PH_NFCRDLIB_EXAMPLE_LPCD_GUARDTIME      100           /* LPCD Guard time(T4) in milli-seconds configured by application for Ncx3320. */
#define PH_NFCRDLIB_EXAMPLE_LPCD_RFON_TIME      50            /* LPCD RFON time(T3) in micro-seconds configured by application for Ncx3320. */
