...
#include "phhalHw_Ncx3320_Settings.h"
 ...
 * copied to application and change the value or customer can Initialize the NCx3320 hal \ref phhalHw_Ncx3320_Init with its array
 */
const uint8_t gkphhalHw_Ncx3320_LoadConfig[] =
{
    PHHAL_HW_NCx3320_ARR_LDREG_FILL(PHHAL_HW_NCx3320_EE_ADDR_I14443A_106),
    PHHAL_HW_NCx3320_ARR_LDREG_FILL(PHHAL_HW_NCx3320_EE_ADDR_I14443A_212),
    PHHAL_HW_NCx3320_ARR_LDREG_FILL(PHHAL_HW_NCx3320_EE_ADDR_I14443A_424),
    PHHAL_HW_NCx3320_ARR_LDREG_FILL(PHHAL_HW_NCx3320_EE_ADDR_I14443A_848),
    PHHAL_HW_NCx3320_ARR_LDREG_FILL(PHHAL_HW_NCx3320_EE_ADDR_I14443B_106),
    PHHAL_HW_NCx3320_ARR_LDREG_FILL(PHHAL_HW_NCx3320_EE_ADDR_I14443B_EMVCO_106),
    PHHAL_HW_NCx3320_ARR_LDREG_FILL(PHHAL_HW_NCx3320_EE_ADDR_I14443B_212),
    PHHAL_HW_NCx3320_ARR_LDREG_FILL(PHHAL_HW_NCx3320_EE_ADDR_I14443B_424),
    PHHAL_HW_NCx3320_ARR_LDREG_FILL(PHHAL_HW_NCx3320_EE_ADDR_I14443B_848),
    PHHAL_HW_NCx3320_ARR_LDREG_FILL(PHHAL_HW_NCx3320_EE_ADDR_FELICA_212),
    PHHAL_HW_NCx3320_ARR_LDREG_FILL(PHHAL_HW_NCx3320_EE_ADDR_FELICA_424),
    PHHAL_HW_NCx3320_ARR_LDREG_FILL(PHHAL_HW_NCx3320_EE_ADDR_I15693_HIGH),
    PHHAL_HW_NCx3320_ARR_LDREG_FILL(PHHAL_HW_NCx3320_EE_ADDR_I15693_FAST_HIGH),
    PHHAL_HW_NCx3320_ARR_LDREG_FILL(PHHAL_HW_NCx3320_EE_ADDR_EPC_UID),
    PHHAL_HW_NCx3320_ARR_LDREG_FILL(PHHAL_HW_NCx3320_EE_ADDR_I18000P3M3_DSM2),
    PHHAL_HW_NCx3320_ARR_LDREG_FILL(PHHAL_HW_NCx3320_EE_ADDR_I18000P3M3_DSM4),
    PHHAL_HW_NCx3320_ARR_LDREG_FILL(PHHAL_HW_NCx3320_EE_ADDR_I18000P3M3_QSM2),
    PHHAL_HW_NCx3320_ARR_LDREG_FILL(PHHAL_HW_NCx3320_EE_ADDR_I18000P3M3_QSM4)
};
...
/* EMVCO:  case_id TB001 */
static const uint8_t PH_MEMLOC_CONST_ROM gkphhalHw_Ncx3320_EMVCO_I14443B_106[] =
{
...
static uint8_t phhalHw_Ncx3320_GetReg[] =
{

        (PHHAL_HW_NCx3320_REG_IRQ0 << 1U) | 0x01,
        (PHHAL_HW_NCx3320_REG_IRQ1 << 1U) | 0x01,
        (PHHAL_HW_NCx3320_REG_ERROR << 1U) | 0x01,
        (PHHAL_HW_NCx3320_REG_FIFOLENGTH << 1U) | 0x01,
        (PHHAL_HW_NCx3320_REG_RXBITCTRL << 1U) |0x01,
        0x00                                                    /* last byte */
};
                                   ...
                                   )
{
    ...
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_ReadRegister(pDataParams, PHHAL_HW_NCx3320_REG_FIFOLENGTH, &bValue));
    wFifoLen = (uint16_t)bValue;

    /* Read out the higher FiFo Level bits if applicable */
    if (pDataParams->bFifoSize == PH_NXPNFCRDLIB_CONFIG_NCx3320_VALUE_FIFOSIZE_512)
    {
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_ReadRegister(pDataParams, PHHAL_HW_NCx3320_REG_FIFOCONTROL, &bValue));

        /* If higher bits are set, we ignore the lower bits since they would change too fast in case of a slow interface. */
        wFifoLen = wFifoLen + ((uint16_t)((uint16_t)bValue & PHHAL_HW_NCx3320_MASK_FIFOLENGTH_HI) << 8U);
                                  ...
                                  )
{
        ...
        (pDataParams->bFifoSize == PH_NXPNFCRDLIB_CONFIG_NCx3320_VALUE_FIFOSIZE_512))
    {
        ...
        /* If higher bits are set, we ignore the lower bits since they would change too fast in case of a slow interface. */
        wFifoLen = (uint16_t)((uint16_t)bValue & PHHAL_HW_NCx3320_MASK_FIFOLENGTH_HI) << 8U;
    }
                                   ...
                                   )
{
    ...
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_FIFOCONTROL, bValue));
                                   ...
                                   )
{
    ...
    else
    {
        ...
        {
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, bAddress, pData[wIndex]));
        }
    }
                                  ...
                                  )
{
    ...
    else
    {
        ...
        for (wIndex = 0; wIndex < wLength; ++wIndex)
        {
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_ReadRegister(pDataParams, bAddress, &pData[wIndex]));
        }
    }
                                     ...
                                     )
{
    ...
    case PHHAL_HW_CARDTYPE_ISO14443A:
        ...
        case PHHAL_HW_RF_DATARATE_106:
            ...
            dwAddrIndex = PHHAL_HW_NCx3320_ARR_INDEX_I14443A_106;
            break;
        case PHHAL_HW_RF_DATARATE_212:
            ...
            dwAddrIndex = PHHAL_HW_NCx3320_ARR_INDEX_I14443A_212;
            break;
        case PHHAL_HW_RF_DATARATE_424:
            ...
            dwAddrIndex = PHHAL_HW_NCx3320_ARR_INDEX_I14443A_424;
            break;
        case PHHAL_HW_RF_DATARATE_848:
            ...
            dwAddrIndex = PHHAL_HW_NCx3320_ARR_INDEX_I14443A_848;
            break;
        default:
    ...
    case PHHAL_HW_CARDTYPE_FELICA_424:
        ...
        case PHHAL_HW_RF_DATARATE_212:
            ...
            dwAddrIndex = PHHAL_HW_NCx3320_ARR_INDEX_FELICA_212;
            break;
        case PHHAL_HW_RF_DATARATE_424:
            ...
            dwAddrIndex = PHHAL_HW_NCx3320_ARR_INDEX_FELICA_424;
            break;
        default:
            return PH_ADD_COMPCODE_FIXED(PH_ERR_INVALID_PARAMETER, PH_COMP_HAL);
        }
    ...
    case PHHAL_HW_CARDTYPE_ISO15693:
        ...
        case PHHAL_HW_RF_RX_DATARATE_HIGH:
            ...
            dwAddrIndex = PHHAL_HW_NCx3320_ARR_INDEX_I15693_HIGH;
            break;
        case PHHAL_HW_RF_RX_DATARATE_FAST_HIGH:
            ...
            dwAddrIndex = PHHAL_HW_NCx3320_ARR_INDEX_I15693_FAST_HIGH;
            break;
    ...
    case PHHAL_HW_CARDTYPE_ICODEEPCUID:
            ...
            (wRxDataRate == PHHAL_HW_RF_DATARATE_EPCUID))
        {
            ...
            dwAddrIndex = PHHAL_HW_NCx3320_ARR_INDEX_EPC_UID;
        }
        else
        {
            return PH_ADD_COMPCODE_FIXED(PH_ERR_INVALID_PARAMETER, PH_COMP_HAL);
    ...
    case PHHAL_HW_CARDTYPE_I18000P3M3:
        ...
        case PHHAL_HW_RX_I18000P3M3_FL_423_MAN2:
                ...
                dwAddrIndex = PHHAL_HW_NCx3320_ARR_INDEX_I18000P3M3_DSM2;
            break;
        ...
        case PHHAL_HW_RX_I18000P3M3_FL_847_MAN2:
                ...
                dwAddrIndex = PHHAL_HW_NCx3320_ARR_INDEX_I18000P3M3_QSM2;
            break;
        case PHHAL_HW_RX_I18000P3M3_FL_423_MAN4:
                ...
                dwAddrIndex = PHHAL_HW_NCx3320_ARR_INDEX_I18000P3M3_DSM4;
            break;
        case PHHAL_HW_RX_I18000P3M3_FL_847_MAN4:
                ...
                dwAddrIndex = PHHAL_HW_NCx3320_ARR_INDEX_I18000P3M3_QSM4;
            break;
        default:
            return PH_ADD_COMPCODE_FIXED(PH_ERR_INVALID_PARAMETER, PH_COMP_HAL);
        }
    ...
    if (pDataParams->bLoadRegMode != PH_OFF)
    {
        ...
        {
            bAsynBaudrate = PH_ON;
            bNoRxReg = PHHAL_HW_NCx3320_RX_REG_NUM;
        }
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_ReadRegister(pDataParams, PHHAL_HW_NCx3320_REG_DRVMODE, &bTxConfig));
        /* Read the DrvMode Register value from EEPROM. */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_Cmd_ReadE2(pDataParams, wEEAddress, 1, &bRegister));
        ...
        if (bAsynBaudrate == PH_ON)
        {
            ...
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_Cmd_LoadReg(
                pDataParams,
                (wEEAddress + (PHHAL_HW_NCx3320_REG_NUM - PHHAL_HW_NCx3320_RX_REG_NUM)),
                (bRegAddress + (PHHAL_HW_NCx3320_REG_NUM - PHHAL_HW_NCx3320_RX_REG_NUM)),
                (bNoRxReg)));
        }
    }
                                       ...
                                       )
{
    ...
    case PHHAL_HW_CONFIG_TXCRC:
        ...
        {
            /* Enable CRC */
            bValue = bRegister| PHHAL_HW_NCx3320_BIT_CRCEN;
        }
    ...
    case PHHAL_HW_CONFIG_RXWAIT_US:
        ...
        if (wValue != pDataParams->wCfgShadow[PHHAL_HW_CONFIG_RXWAIT_US])
        {
            ...
            {
            case PHHAL_HW_RF_DATARATE_106:
                fValue = ((float32_t)wValue/PHHAL_HW_NCx3320_ETU_I14443);
                break;
            case PHHAL_HW_RF_DATARATE_212:
                fValue = ((float32_t)wValue/PHHAL_HW_NCx3320_ETU_212);
                break;
            case PHHAL_HW_RF_DATARATE_424:
                fValue = ((float32_t)wValue/PHHAL_HW_NCx3320_ETU_424);
                break;
            case PHHAL_HW_RF_DATARATE_848:
                fValue = ((float32_t)wValue/PHHAL_HW_NCx3320_ETU_848);
                break;
            case PHHAL_HW_RF_RX_DATARATE_FAST_HIGH:
                fValue = ((float32_t)wValue/PHHAL_HW_NCx3320_ETU_I15693_HIGH);
                break;
            case PHHAL_HW_RF_RX_DATARATE_HIGH:
                fValue = ((float32_t)wValue/PHHAL_HW_NCx3320_ETU_I15693);
                break;
            case PHHAL_HW_RF_DATARATE_EPCUID:
                fValue = ((float32_t)wValue/PHHAL_HW_NCx3320_ETU_EPCUID);
                break;
            case PHHAL_HW_RX_I18000P3M3_FL_423_MAN2:
            case PHHAL_HW_RX_I18000P3M3_FL_847_MAN2:
            case PHHAL_HW_RX_I18000P3M3_FL_423_MAN4:
            case PHHAL_HW_RX_I18000P3M3_FL_847_MAN4:
                fValue = ((float32_t)wValue/PHHAL_HW_NCx3320_ETU_I18000);
                break;
            default:
                return PH_ADD_COMPCODE_FIXED(PH_ERR_INVALID_PARAMETER, PH_COMP_HAL);
            }
    ...
    case PHHAL_HW_CONFIG_SET_SYMBOL_SEND:
        ...
        if (wValue == PH_ON)
        {
            bRegister &= (uint8_t)~(uint8_t)PHHAL_HW_NCx3320_MASK_SYMBOL_SEND;
        }
        /* PH_OFF implies Setting Bit-3 (DataEn Bit in TxDataNum). */
        else
        {
            bRegister |= PHHAL_HW_NCx3320_MASK_SYMBOL_SEND;
        }
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_TXDATANUM, bRegister));
        break;
    ...
    case PHHAL_HW_CONFIG_ASK100:
        ...
        if (bValue != bRegister)
        {
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_DRVMODE, bValue));
        }
        break;
                                   ...
                                   )
{
    ...
    case PHHAL_HW_RF_RX_DATARATE_FAST_HIGH:
        /* parameter check */
        if (wTimeEtu > (PHHAL_HW_NCx3320_MASK_RXWAIT >> 1U))
        {
            return PH_ADD_COMPCODE_FIXED(PH_ERR_INVALID_PARAMETER, PH_COMP_HAL);
        }
        wTimeEtu <<= 1U;
    ...
    case PHHAL_HW_RF_DATARATE_EPCUID:
        /* parameter check */
        if (wTimeEtu > (PHHAL_HW_NCx3320_MASK_RXWAIT >> 2U))
        {
            return PH_ADD_COMPCODE_FIXED(PH_ERR_INVALID_PARAMETER, PH_COMP_HAL);
        }
        wTimeEtu <<= 2U;
    ...
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_RXWAIT, bRegister));
                                   ...
                                   )
{
    ...
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_ReadRegister(pDataParams, PHHAL_HW_NCx3320_REG_TXWAITCTRL, &bRegister));
    ...
    bRegister |= (uint8_t)((wTimeUs >> 5U) & PHHAL_HW_NCx3320_MASK_TXWAITHI);

    /* Write changed register */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_TXWAITCTRL, bRegister));

    /* Set the 8 LSBs */
    bRegister = (uint8_t)wTimeUs;
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_TXWAITLO, bRegister));
                                ...
                                )
{
    ...
    if (bUnit == PHHAL_HW_TIME_MICROSECONDS)
    {
        ...
        else
        {
            ...
            fT0Reload = (PHHAL_HW_NCx3320_TIMER0_FREQ * PHHAL_HW_NCx3320_ETU_I14443);
    ...
    else
    {
        ...
        fT0Reload = (1000.0f * PHHAL_HW_NCx3320_TIMER0_FREQ);
        wT0Reload = (uint16_t)fT0Reload;
    ...
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_T0RELOADHI, (uint8_t)(wT0Reload >> 8U)));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_T0RELOADLO, (uint8_t)(wT0Reload)));

    /* Write T1 reload value */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_T1RELOADHI, (uint8_t)(wT1Reload >> 8U)));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_T1RELOADLO, (uint8_t)(wT1Reload)));
                                ...
                                )
{
    ...
    /* Get T0 reload value */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_ReadRegister(pDataParams, PHHAL_HW_NCx3320_REG_T0RELOADHI, &bRegister));
    wT0Reload = (uint16_t)bRegister << 8U;
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_ReadRegister(pDataParams, PHHAL_HW_NCx3320_REG_T0RELOADLO, &bRegister));
    wT0Reload |= (uint16_t)bRegister;

    /* Get T1 reload value */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_ReadRegister(pDataParams, PHHAL_HW_NCx3320_REG_T1RELOADHI, &bRegister));
    wT1Reload = (uint16_t)bRegister << 8U;
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_ReadRegister(pDataParams, PHHAL_HW_NCx3320_REG_T1RELOADLO, &bRegister));
    wT1Reload |= (uint16_t)bRegister;

    /* Get T0 counter value */
    if ((wExchangeStatus & PH_ERR_MASK) != PH_ERR_IO_TIMEOUT)
    {
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_ReadRegister(pDataParams, PHHAL_HW_NCx3320_REG_T0COUNTERVALHI, &bRegister));
        wT0Value = (uint16_t)bRegister << 8U;
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_ReadRegister(pDataParams, PHHAL_HW_NCx3320_REG_T0COUNTERVALLO, &bRegister));
    ...
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_ReadRegister(pDataParams, PHHAL_HW_NCx3320_REG_T1COUNTERVALHI, &bRegister));
    wT1Value = (uint16_t)bRegister << 8U;
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_ReadRegister(pDataParams, PHHAL_HW_NCx3320_REG_T1COUNTERVALLO, &bRegister));
    ...
    case PHHAL_HW_CARDTYPE_ISO15693:
        *pDelayUs = gkphhalHw_Ncx3320_DigiDelays_Us[bIndex][wDataRate - PHHAL_HW_RF_RX_DATARATE_LOW];
        ...
        if (bIsTimeout != PH_OFF)
        {
            ...
            {
                *pDelayUs = *pDelayUs + (PHHAL_HW_NCx3320_I15693_ADD_DELAY_US >> 1U);
            }
        }
        break;
    case PHHAL_HW_CARDTYPE_ICODEEPCUID:
                                     ...
                                     )
{
    ...
    case PHHAL_HW_NCx3320_CMD_ACKREQ:
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_Cmd_AckReq(pDataParams, &bBuffer[0], 3, pRxBuffer, pRxLength));
    ...
    default:
        ...
        if ((0U != (bCmd & PHHAL_HW_NCx3320_BIT_STANDBY)) ||
        ...
        /* Flush FiFo */
        if (0U == (wOption & PHHAL_HW_NCx3320_OPTION_FIFO_NOCLEAR))
        {
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_FlushFifo(pDataParams));
        }
        ...
        if (0U != (bCmdNoWrite))
        {
            ...
            bRegister &= PHHAL_HW_NCx3320_BIT_IRQINV; /* clear all the interrupts */
            bRegister |= (0x7FU & bIrq0WaitFor); /* Do not modify the IRQINV bit. */
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_IRQ0EN, bRegister));

            /* Enable IRQ1 interrupt sources */
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_ReadRegister(pDataParams, PHHAL_HW_NCx3320_REG_IRQ1EN, &bRegister));
            bRegister = PHHAL_HW_NCx3320_BIT_IRQPUSHPULL;
            bRegister |= PHHAL_HW_NCx3320_BIT_GLOBALIRQ | bIrq1WaitFor;
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_IRQ1EN, bRegister));
        }

        /* start timer manually if requested */
        if (0U != (wOption & PHHAL_HW_NCx3320_RXTX_TIMER_START))
        {
         ...
         * system will hang. */
        if ((bCmd & (uint8_t)~(uint8_t)PHHAL_HW_NCx3320_BIT_STANDBY) == PHHAL_HW_NCx3320_CMD_LPCD)
        {
        ...
        /* start the command */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_COMMAND, bCmd));
        //alan 2020.12.03
        
        /* wait until the command is finished */
        bWaitIrqEn = (bCmdNoWrite != PH_OFF) ? PH_OFF : PH_ON;
        bWaitIrqPowerDownCheck = ((bCmd == PHHAL_HW_NCx3320_CMD_SOFTRESET) || (0U != (bCmd & PHHAL_HW_NCx3320_BIT_STANDBY))) ? PH_ON : PH_OFF;
        //DEBUG_PRINTF("[User Log]before phhalHw_Ncx3320_WaitIrq\r\n");
        ...
        //DEBUG_PRINTF("[User Log]bIrq1WaitFor = %x,bIrq1Reg = %x\r\n",bIrq1WaitFor,bIrq1Reg);
        /* Timeout handling */
        if ((0U != (bIrq1WaitFor & PHHAL_HW_NCx3320_BIT_TIMER1IRQ)) &&
            (0U != (bIrq1Reg & PHHAL_HW_NCx3320_BIT_TIMER1IRQ)))
        {
            //DEBUG_PRINTF("[User Log]entry timeout\r\n");
            /* stop the command */
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(
                pDataParams,
                                    ...
                                    )
{
    ...
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_TXAMP, 0x00U));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_TXI, 0x00U));

    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_RCV, 0x12));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_SIGPROTEST, 0x00U));

    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_DRVCON, 0x01));

    /* Preserve TxEn bit. */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_ReadRegister(pDataParams, PHHAL_HW_NCx3320_REG_DRVMODE, &bRegister));
    bRegister = ((bRegister & (uint8_t)PHHAL_HW_NCx3320_BIT_TXEN) | 0x47U);
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_DRVMODE, bRegister));

    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_RXANA, 0x0A));
    ...
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_TXBITMOD, 0x80));
    ...
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_TXSYM2, 0x00U));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_TXSYM3, 0x00U));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_TXSYM32LEN, 0x00U));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_TXSYM32MOD, 0x00U));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_TXSYM1L, 0xA1));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_TXSYM1H, 0x01));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_TXMODWIDTH, 0x00U));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_TXWAITCTRL, 0x80));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_TXWAITLO, 0x12));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_TXDATACON, 0xC5));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_TXSYMFREQ, 0x05));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_TXCRCCON, 0x05));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_TXDATANUM, 0x08));

    /* Initialize Receiver */

    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_RXBITMOD, 0x08));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_RXWAIT, 0x00U));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_RXBITCTRL, 0x00U));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_RXEOFSYM, 0x0B));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_RXCOLL, 0x00U));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_RXCRCCON, 0x05));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_RXSYNCMOD, 0x04));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_RXSYNCVAlL, 0x01));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_RXSYNCVAlH, 0x00U));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_RXTHRESHOLD, 0x36));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_RXSVETTE, 0xF0));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_RXMOD,0x0C));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_RXCORR,0x80));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_RXCTRL,0x04));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_LPO_TRIMM,0x00U));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_DACVAL,0x02));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_DACVAL,0x27));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_ANAXTAL,0x0A));

    /* Initialize FIFO */

    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_FIFOCONTROL,0x14));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_WATERLEVEL,0x00U));

    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_TCONTROL, 0x0F));

    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_TXDATANUM, 0x0C));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_RXBITCTRL, 0x70));

    return statusTmp;
}


phStatus_t phhalHw_Ncx3320_GetErrorStatus(
                                    phhalHw_Ncx3320_DataParams_t * pDataParams,
...
phStatus_t phhalHw_Ncx3320_GetMultiReg(phhalHw_Ncx3320_DataParams_t * pDataParams, uint8_t * pData)
{
    uint16_t PH_MEMLOC_REM         wTxLen = 0;
    uint16_t PH_MEMLOC_REM         wRxLen = 0;
    phStatus_t PH_MEMLOC_REM       status;

    wTxLen = (uint16_t)sizeof(phhalHw_Ncx3320_GetReg);
    wRxLen = wTxLen;
...
phStatus_t phhalHw_Ncx3320_CheckForEmdError(phhalHw_Ncx3320_DataParams_t * pDataParams, uint8_t bIrq0WaitFor, uint8_t bIrq1WaitFor, uint32_t * pdwMultiReg, uint32_t * pdwPrevReg)
{
    ...
    /* Enable IRQ0 interrupt sources */
    statusTmp = phhalHw_Ncx3320_ReadRegister(pDataParams, PHHAL_HW_NCx3320_REG_IRQ0EN, &bIrq0EnReg_Orig);
    /* Clear any existing interrupts */
    bIrq0EnReg = bIrq0EnReg_Orig & PHHAL_HW_NCx3320_BIT_IRQINV;
    bIrq0EnReg |= (0x7fU & bIrq0WaitFor); /* Assign other bits except 8th bit */

    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_IRQ0EN, bIrq0EnReg));

    /* Enable IRQ1 interrupt sources */
    bIrq1EnReg = PHHAL_HW_NCx3320_BIT_IRQPUSHPULL;
    bIrq1EnReg |= PHHAL_HW_NCx3320_BIT_GLOBALIRQ | bIrq1WaitFor;
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_IRQ1EN, bIrq1EnReg));
    ...
    do
    {
...
#endif
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_GetMultiReg(pDataParams, (uint8_t*)&aTempRxBuf));
        bRxBitCtrl = aTempRxBuf[5] & PHHAL_HW_NCx3320_MASK_RXLASTBITS;

        if(((0U != (PHHAL_HW_EMD_NOISE_CHECK(aTempRxBuf[3]))) &&
           (0U != (aTempRxBuf[1] & PHHAL_HW_NCx3320_BIT_RXIRQ))) &&
            ...
            ((aTempRxBuf[4] & 0xFFU) <= (pDataParams->bEmdNoiseMaxDataLen)))))
        {
            ...
            if ((pDataParams->bCardType == PHHAL_HW_CARDTYPE_ISO14443A) &&
                (0U != (bRxBitCtrl)) &&
                (0U != (PHHAL_HW_NCx3320_BIT_PROTERR & aTempRxBuf[3])) &&
                ((aTempRxBuf[4] & 0xFFU) == (pDataParams->bEmdNoiseMaxDataLen)))
            {
                break;
            }
            ...
            /* Restart reception */
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_COMMAND,
                PHHAL_HW_NCx3320_CMD_RECEIVE));
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_FIFOCONTROL,
                PHHAL_HW_NCx3320_BIT_FLUSHFIFO));
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_IRQ0,
                (uint8_t)(~(uint8_t)PHHAL_HW_NCx3320_BIT_SET)));
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_TCONTROL,
                (PHHAL_HW_NCx3320_BIT_T0STARTSTOPNOW | PHHAL_HW_NCx3320_BIT_T1STARTSTOPNOW | PHHAL_HW_NCx3320_BIT_T0RUNNING | PHHAL_HW_NCx3320_BIT_T1RUNNING)));
        ...
        else
        {
            ...
            if ((aTempRxBuf[4] & 0xFFU) >= pDataParams->bEmdNoiseMaxDataLen)
            {
                do
                {
                    ...
                    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_GetMultiReg(pDataParams, (uint8_t*)&aTempRxBuf));
                } while (0U == (aTempRxBuf[1] & (PHHAL_HW_NCx3320_BIT_RXIRQ | PHHAL_HW_NCx3320_BIT_HIALERTIRQ)));
                break;
            }
        }
#ifndef _WIN32
        ...
        bEvtFlag = PH_ON;
#endif
    }while (!( (0U != (aTempRxBuf[2] & PHHAL_HW_NCx3320_BIT_TIMER1IRQ)) ||
        (0U != (aTempRxBuf[1] & PHHAL_HW_NCx3320_BIT_RXIRQ))));
    ...
    *pdwPrevReg = dwSaveRegReadValue;
    ...
    bIrq1EnReg &= (PHHAL_HW_NCx3320_BIT_IRQPUSHPULL | PHHAL_HW_NCx3320_BIT_GLOBALIRQ);
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_IRQ1EN, bIrq1EnReg));

    return PH_ERR_SUCCESS;
}

void phhalHw_Ncx3320_CreateRespFrame(uint8_t* bInBuff, uint8_t bDataPos, uint8_t * bOutBuff)
{
    ...
    if(0U != (bTemp & PHHAL_HW_NCx3320_BIT_PROTERR))
    {
    ...
    if(0U != (bTemp & PHHAL_HW_NCx3320_BIT_COLLDET))
    {
    ...
    if(0U != (bTemp & PHHAL_HW_NCx3320_BIT_INTEGERR))
    {
...
phStatus_t phhalHw_Ncx3320_FrameRxMultiplePkt(phhalHw_Ncx3320_DataParams_t * pDataParams)
{
    uint8_t bIndex;
    uint8_t bFrameCount;
    ...
    if(bFrameCount > 0U)
    {
        do{
            ...
            phhalHw_Ncx3320_CreateRespFrame(pDataParams->pRxBuffer, bRespStartPos, aRxMulFrame);
...
phStatus_t phhalHw_Ncx3320_18000p3m3_Sw_Exchange(
                                               phhalHw_Ncx3320_DataParams_t * pDataParams,
                                               uint16_t wOption,
                                               uint8_t * pTxBuffer,
                                               uint16_t wTxLength,
...
phStatus_t phhalHw_Ncx3320_18000p3m3_Sw_Select(
                                             phhalHw_Ncx3320_DataParams_t * pDataParams,
                                             uint8_t * pSelCmd,
                                             uint8_t bSelCmdLen,
                                             ...
                                             )
{
    ...
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_SetConfig(
        ...
        PHHAL_HW_NCx3320_I18000P3M3_SW_T4_MIN_US));
    ...
    /* Exchange command */
    status = phhalHw_Ncx3320_18000p3m3_Sw_Exchange(
        pDataParams,
        PH_EXCHANGE_DEFAULT,
        pSelCmd,
        bSelCmdLen,
...
phStatus_t phhalHw_Ncx3320_18000p3m3_Sw_BeginRound(
                                                 phhalHw_Ncx3320_DataParams_t * pDataParams,
                                                 ...
                                                 )
{
    ...
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_SetConfig(
        pDataParams,
        PHHAL_HW_CONFIG_TXWAIT_US,
        PHHAL_HW_NCx3320_I18000P3M3_SW_T2_MIN_US));

    /* Set T1+T3 Timeout */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_SetConfig(
        pDataParams,
        PHHAL_HW_CONFIG_TIMEOUT_VALUE_US,
        PHHAL_HW_NCx3320_I18000P3M3_SW_T1_MAX_US + PHHAL_HW_NCx3320_I18000P3M3_SW_T3_MIN_US + PHHAL_HW_NCx3320_I18000P3M3_SW_DELTA_MIN_US));
    ...
    /* Exchange command */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_18000p3m3_Sw_Exchange(
        pDataParams,
        PH_EXCHANGE_DEFAULT,
        pBeginRndCmd,
        3,
...
phStatus_t phhalHw_Ncx3320_18000p3m3_Sw_NextSlot(
                                               phhalHw_Ncx3320_DataParams_t * pDataParams
                                               )
{
    phStatus_t  PH_MEMLOC_REM statusTmp;
    ...
    /* Build Command frame */
    aCmd[0] = (PHHAL_HW_NCx3320_I18000P3M3_CMD_NEXT_SLOT << 4U) | (pDataParams->bSession << 2U); /* 2 bits left */
...
phStatus_t phhalHw_Ncx3320_18000p3m3_Sw_Ack(
                                          phhalHw_Ncx3320_DataParams_t *pDataParams,
                                          uint8_t **ppRxBuffer,
                                          uint16_t *pRxLength,
                                          uint8_t *pRxLastBits
                                          )
{
    ...
    /* Build Command frame */
    aCmd[0] = (PHHAL_HW_NCx3320_I18000P3M3_CMD_ACK << 6U) | (pDataParams->abStoredCRC[0] >> 2U);    /* 0 bits left */
...
phStatus_t phhalHw_Ncx3320_18000p3m3_Sw_ReqRn(
                                            phhalHw_Ncx3320_DataParams_t * pDataParams,
                                            uint8_t ** ppRxBuffer
                                            )
{
    ...
    bCmd[0] = PHHAL_HW_NCx3320_I18000P3M3_CMD_REQ_RN;
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_18000p3m3_Sw_Exchange(
        pDataParams,
...
void phhalHw_Ncx3320_WriteSSEL(void *pBalDataParams, uint8_t bValue)
{
#ifndef _WIN32
