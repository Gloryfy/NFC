                                  ...
                                  )
{
    ...
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_Int_LoadTimer(
        ...
        dwReload,
        PHHAL_HW_NCx3320_REG_T3RELOADHI));
    //DEBUG_PRINTF("[User Log] After phhalHw_Ncx3320_Int_Load T3 Timer\r\n");
    ...
    //DEBUG_PRINTF("[User Log] After phhalHw_Ncx3320_Int_Load T4 Timer\r\n");
    /* Set AutoTrimm bit if requested */
    ...
    status = phhalHw_Ncx3320_Command_Int(
        ...
        NULL);
    //alan 2020.12.03
    //DEBUG_PRINTF("[User Log] After phhalHw_Ncx3320_Command_Int status = 0x%04x\r\n",status);
    ...
    {
        //DEBUG_PRINTF("[User Log] Status = 0x%04x \r\n",(status & PH_ERR_MASK));
    ...
    {
        //DEBUG_PRINTF("[User Log] 0U == (bRegister & PHHAL_HW_NCx3320_BIT_LPCDIRQ) \r\n");
