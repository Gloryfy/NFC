...
#ifndef PHHALHW_NCx3330_WAIT_H
#define PHHALHW_NCx3330_WAIT_H
...
phStatus_t phhalHw_Ncx3330_WaitIrq(
    phhalHw_Ncx3330_DataParams_t * pDataParams,                         /**<[In] DataParameter representing this layer. */
