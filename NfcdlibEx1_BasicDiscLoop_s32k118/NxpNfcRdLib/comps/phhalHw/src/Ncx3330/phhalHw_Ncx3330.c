...
#include <phDriver.h>
#include "phhalHw_Ncx3330.h"
#include "phhalHw_Ncx3330_Instr.h"
#include "phhalHw_Ncx3330_Reg.h"
#include "phhalHw_Ncx3330_Int.h"
#include "phhalHw_Ncx3330_Wait.h"
#include <phTools.h>
...
static void phhalHw_Ncx3330_EventCallback(void * pDataParams);
static void phhalHw_Ncx3330_Reset(void);
static void phhalHw_Ncx3330_GuardTimeCallBck(void);
#ifndef _WIN32
static void phhalHw_Ncx3330_WriteSSEL(phbalReg_Type_t *pBalDataParams, uint8_t bValue);
#endif

#define SET_NCx3330_SHADOW(USED_SHADOW)   \
...
static const uint16_t PH_MEMLOC_CONST_ROM wNcx3330_DefaultShadow_I14443a[][2] =
{
    ...
    {PHHAL_HW_CONFIG_TIMEOUT_VALUE_US,      PHHAL_HW_NCx3330_DEFAULT_TIMEOUT},
    {PHHAL_HW_CONFIG_TIMEOUT_VALUE_MS,      0x0000},
    {PHHAL_HW_CONFIG_ASK100,                PH_ON}
};

/* Default shadow for ISO14443-3B Mode */
static const uint16_t PH_MEMLOC_CONST_ROM wNcx3330_DefaultShadow_I14443b[][2] =
{
    ...
    {PHHAL_HW_CONFIG_TIMEOUT_VALUE_US,      PHHAL_HW_NCx3330_DEFAULT_TIMEOUT},
    {PHHAL_HW_CONFIG_TIMEOUT_VALUE_MS,      0x0000},
    {PHHAL_HW_CONFIG_MODINDEX,              PHHAL_HW_NCx3330_MODINDEX_I14443B},
    {PHHAL_HW_CONFIG_ASK100,                PH_OFF}
};

/* Default shadow for FeliCa Mode */
static const uint16_t PH_MEMLOC_CONST_ROM wNcx3330_DefaultShadow_Felica[][2] =
{
    {PHHAL_HW_CONFIG_PARITY,                PH_OFF},
    {PHHAL_HW_CONFIG_TXCRC,                 PH_ON},
    {PHHAL_HW_CONFIG_RXCRC,                 PH_ON},
    ...
    {PHHAL_HW_CONFIG_TIMEOUT_VALUE_US,      PHHAL_HW_NCx3330_DEFAULT_TIMEOUT},
    {PHHAL_HW_CONFIG_TIMEOUT_VALUE_MS,      0x0000},
    {PHHAL_HW_CONFIG_MODINDEX,              PHHAL_HW_NCx3330_MODINDEX_FELICA},
    {PHHAL_HW_CONFIG_ASK100,                PH_OFF}
};

/* Default shadow for FeliCa Mode at 424 baud rate */
static const uint16_t PH_MEMLOC_CONST_ROM wNcx3330_DefaultShadow_Felica_424[][2] =
{
    {PHHAL_HW_CONFIG_PARITY,                PH_OFF},
    {PHHAL_HW_CONFIG_TXCRC,                 PH_ON},
    {PHHAL_HW_CONFIG_RXCRC,                 PH_ON},
...
static const uint16_t PH_MEMLOC_CONST_ROM wNcx3330_DefaultShadow_I15693[][2] =
{
    {PHHAL_HW_CONFIG_PARITY,                PH_OFF},
    {PHHAL_HW_CONFIG_TXCRC,                 PH_ON},
    {PHHAL_HW_CONFIG_RXCRC,                 PH_ON},
    ...
    {PHHAL_HW_CONFIG_TIMEOUT_VALUE_US,      PHHAL_HW_NCx3330_DEFAULT_TIMEOUT},
    {PHHAL_HW_CONFIG_TIMEOUT_VALUE_MS,      0x0000},
    {PHHAL_HW_CONFIG_MODINDEX,              PHHAL_HW_NCx3330_MODINDEX_I15693},
    {PHHAL_HW_CONFIG_ASK100,                PH_ON}
};

/* Default shadow for ISO18000-3 Mode3 */
static const uint16_t PH_MEMLOC_CONST_ROM wNcx3330_DefaultShadow_I18000p3m3[][2] =
{
    {PHHAL_HW_CONFIG_PARITY,                PH_OFF},
    {PHHAL_HW_CONFIG_TXCRC,                 PH_ON},
    {PHHAL_HW_CONFIG_RXCRC,                 PH_ON},
    ...
    {PHHAL_HW_CONFIG_TIMEOUT_VALUE_US,      PHHAL_HW_NCx3330_DEFAULT_TIMEOUT},
    {PHHAL_HW_CONFIG_TIMEOUT_VALUE_MS,      0x0000},
    {PHHAL_HW_CONFIG_MODINDEX,              PHHAL_HW_NCx3330_MODINDEX_I18000P3M3},
    {PHHAL_HW_CONFIG_ASK100,                PH_OFF}
};
...
static const uint16_t PH_MEMLOC_CONST_ROM wNcx3330_DefShadow_I18092m_Active[][2] =
{
    {PHHAL_HW_CONFIG_PARITY,                PH_ON},
    {PHHAL_HW_CONFIG_TXCRC,                 PH_ON},
    {PHHAL_HW_CONFIG_RXCRC,                 PH_ON},
...
static const uint16_t PH_MEMLOC_CONST_ROM wNcx3330_DefShadow_I18092m_212_Active[][2] =
{
    {PHHAL_HW_CONFIG_PARITY,                PH_OFF},
    {PHHAL_HW_CONFIG_TXCRC,                 PH_ON},
    {PHHAL_HW_CONFIG_RXCRC,                 PH_ON},
...
static const uint16_t PH_MEMLOC_CONST_ROM wNcx3330_DefShadow_I18092m_424_Active[][2] =
{
    {PHHAL_HW_CONFIG_PARITY,                PH_OFF},
    {PHHAL_HW_CONFIG_TXCRC,                 PH_ON},
    {PHHAL_HW_CONFIG_RXCRC,                 PH_ON},
...
phStatus_t phhalHw_Ncx3330_GetDataParamsSize(uint16_t * pDataParamsSize)
{
    ...
    *pDataParamsSize = (uint16_t)sizeof(phhalHw_Ncx3330_DataParams_t);
...
static void phhalHw_Ncx3330_EventCallback(void * pDataParams)
{
    phhalHw_Ncx3330_DataParams_t * pNcx3330DataParams = NULL;

    pNcx3330DataParams = (phhalHw_Ncx3330_DataParams_t*) pDataParams;
    /* Post Abort Event. */
    (void)phOsal_EventPost(&pNcx3330DataParams->HwEventObj.EventHandle, E_OS_EVENT_OPT_POST_ISR, E_PH_OSAL_EVT_RF, NULL);
}
...
phStatus_t phhalHw_Ncx3330_Init(
    ...
    )
{
    ...
    if(sizeof(phhalHw_Ncx3330_DataParams_t) != wSizeOfDataParams)
    {
    ...
    /* This is the constructor for the Ncx3330 HAL, let's initialize the private data */
    pDataParams->wId                    = PH_COMP_HAL | PHHAL_HW_NCx3330_ID;
    ...
    pDataParams->bLpcdMode              = PHHAL_HW_NCx3330_LPCD_MODE_DEFAULT;
    ...
    pDataParams->pRFISRCallback         = &phhalHw_Ncx3330_EventCallback;
    pDataParams->pTimerISRCallBack      = &phhalHw_Ncx3330_GuardTimeCallBck;
    ...
    /* Reset Ncx3330 Front-end. */
    phhalHw_Ncx3330_Reset();
    ...
    if(((phbalReg_Type_t *)pBalDataParams)->bBalType == PHBAL_REG_TYPE_SPI)
    {
        ...
        phhalHw_Ncx3330_WriteSSEL(pBalDataParams, PH_DRIVER_SET_LOW);

        /* delay of ~2 ms */
        phDriver_TimerStart(PH_DRIVER_TIMER_MILLI_SECS, PHHAL_HW_NCx3330_DELAY_TO_CHECK_TESTBUS, NULL);
        ...
        /* De-assert NSS pin. */
        phhalHw_Ncx3330_WriteSSEL(pBalDataParams, PH_DRIVER_SET_HIGH);
    }

#endif

    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_ReadE2Prom(pDataParams, PHHAL_HW_NCx3330_FIRMWARE_VERSION_ADDR, bFirmwareVer, 2U));
    ...
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_ReadE2Prom(pDataParams, PHHAL_HW_NCx3330_TESTBUS_ENABLE_ADDR, &pDataParams->bIsTestBusEnabled, 1U));
    ...
    /* Disable Idle IRQ */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_WriteRegisterAndMask(pDataParams, IRQ_ENABLE, (uint32_t)~IRQ_SET_CLEAR_IDLE_IRQ_CLR_MASK));

    /* Clear all IRQs  */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_WriteRegister(pDataParams, IRQ_SET_CLEAR, PHHAL_HW_NCx3330_IRQ_SET_CLEAR_ALL_MASK));
    ...
    /* Check if Firmware version is above 3.4, which also verifies Ncx3330 is initialized. */
    ...
    else
    {
        ...
        if (pDataParams->wFirmwareVer >= 0x308U)
        {
            ...
            phhalHw_Ncx3330_Instr_ReadE2Prom(
                pDataParams,
                PHHAL_HW_NCx3330_DIGITAL_DELAY_CONFIG_ADDR,
                &bDigitalDelayCfg,
                PHHAL_HW_NCx3330_DIGITAL_DELAY_CONFIG_LEN);

            /* Apply FW Digital delay and enable timer 1 for the use of FDT/FWT for FW version 3.8 onwards. */

            if (((0U == ((bDigitalDelayCfg & PHHAL_HW_NCx3330_DIGITAL_DELAY_ENABLE)))) ||
                (!((bDigitalDelayCfg & PHHAL_HW_NCx3330_FDT_TIMER_USED_MASK) == ((PHHAL_HW_NCx3330_FDT_TIMER_USED) << 1U))))
            {
                /* Clear timer bits. */
                bDigitalDelayCfg &= (uint8_t)~(PHHAL_HW_NCx3330_FDT_TIMER_USED_MASK);

                /* Enable FW digital delay and timer 1 for FDT/FWT. */
                bDigitalDelayCfg |= (uint8_t)(PHHAL_HW_NCx3330_DIGITAL_DELAY_ENABLE | ((PHHAL_HW_NCx3330_FDT_TIMER_USED) << 1U));
...
phStatus_t phhalHw_Ncx3330_WriteRegister(
    phhalHw_Ncx3330_DataParams_t * pDataParams,
    uint8_t  bAddress,
    uint32_t dwValue
    )
{
    return phhalHw_Ncx3330_Instr_WriteRegister(  \
        pDataParams,  \
        bAddress,  \
        dwValue);
}
...
phStatus_t phhalHw_Ncx3330_ReadRegister(
    phhalHw_Ncx3330_DataParams_t * pDataParams,
    uint8_t bAddress,
    uint32_t * pValue)
{
    return phhalHw_Ncx3330_Instr_ReadRegister(   \
        pDataParams,  \
        bAddress,  \
        pValue);   \
...
phStatus_t phhalHw_Ncx3330_ApplyProtocolSettings(
    phhalHw_Ncx3330_DataParams_t * pDataParams,
    uint8_t bCardType)
{
    phStatus_t PH_MEMLOC_REM statusTmp;
    ...
    /* Disable the EMD. */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_SetConfig(pDataParams, PHHAL_HW_CONFIG_SET_EMD, PH_OFF));
    ...
    case PHHAL_HW_CARDTYPE_ISO14443A:
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp,phhalHw_Ncx3330_Instr_LoadRfConfiguration(pDataParams, PHHAL_HW_NCx3330_RF_TX_ISO14443A_106_MILLER, PHHAL_HW_NCx3330_RF_RX_ISO14443A_106_MANCH_SUBC));  /* Masking RxDataRate with Minimum Configuration Index */
        SET_NCx3330_SHADOW(wNcx3330_DefaultShadow_I14443a);
    ...
    case PHHAL_HW_CARDTYPE_ISO14443B:
        /* Use 14443b shadow */
        PH_CHECK_SUCCESS_FCT(statusTmp,phhalHw_Ncx3330_Instr_LoadRfConfiguration(pDataParams, PHHAL_HW_NCx3330_RF_TX_ISO14443B_106_NRZ, PHHAL_HW_NCx3330_RF_RX_ISO14443B_106_BPSK));  /* Masking RxDataRate with Minimum Configuration Index */
        SET_NCx3330_SHADOW(wNcx3330_DefaultShadow_I14443b);
        /* Update Datarate in shadow for parity setting */
        wTxDatarate = PHHAL_HW_RF_DATARATE_106;
        wRxDatarate = PHHAL_HW_RF_DATARATE_106;
        break;
    ...
    case PHHAL_HW_CARDTYPE_FELICA_212:
        /* Use FeliCa shadow */
        PH_CHECK_SUCCESS_FCT(statusTmp,phhalHw_Ncx3330_Instr_LoadRfConfiguration(pDataParams, PHHAL_HW_NCx3330_RF_TX_FELICA_212, PHHAL_HW_NCx3330_RF_RX_FELICA_212));  /* Masking RxDataRate with Minimum Configuration Index */
        SET_NCx3330_SHADOW(wNcx3330_DefaultShadow_Felica);
        wTxDatarate = PHHAL_HW_RF_DATARATE_212;
        wRxDatarate = PHHAL_HW_RF_DATARATE_212;

        /* Configure FeliCa EMD Control Register */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_SetConfig_FelicaEmdReg(pDataParams));
        break;


    case PHHAL_HW_CARDTYPE_FELICA_424:
        /* Use FeliCa shadow for 424*/
        PH_CHECK_SUCCESS_FCT(statusTmp,phhalHw_Ncx3330_Instr_LoadRfConfiguration(pDataParams, PHHAL_HW_NCx3330_RF_TX_FELICA_424, PHHAL_HW_NCx3330_RF_RX_FELICA_424));  /* Masking RxDataRate with Minimum Configuration Index */

        SET_NCx3330_SHADOW(wNcx3330_DefaultShadow_Felica_424);
    ...
    case PHHAL_HW_CARDTYPE_I18092M_ACTIVE_106:
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp,phhalHw_Ncx3330_Instr_LoadRfConfiguration(pDataParams, PHHAL_HW_NCx3330_RF_TX_NFC_AI_106_106, PHHAL_HW_NCx3330_RF_RX_NFC_AI_106));  /* Masking RxDataRate with Minimum Configuration Index */
        SET_NCx3330_SHADOW(wNcx3330_DefShadow_I18092m_Active);
        wTxDatarate = PHHAL_HW_RF_DATARATE_106;
        wRxDatarate = PHHAL_HW_RF_DATARATE_106;
        /* Enable active mode */
    ...
    case PHHAL_HW_CARDTYPE_I18092M_ACTIVE_212:
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp,phhalHw_Ncx3330_Instr_LoadRfConfiguration(pDataParams, PHHAL_HW_NCx3330_RF_TX_NFC_AI_212_212, PHHAL_HW_NCx3330_RF_RX_NFC_AI_212));  /* Masking RxDataRate with Minimum Configuration Index */
        SET_NCx3330_SHADOW(wNcx3330_DefShadow_I18092m_212_Active);
        wTxDatarate = PHHAL_HW_RF_DATARATE_212;
        wRxDatarate = PHHAL_HW_RF_DATARATE_212;
        /* Enable active mode */
        pDataParams->bActiveMode = PH_ON;
    ...
    case PHHAL_HW_CARDTYPE_I18092M_ACTIVE_424:
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp,phhalHw_Ncx3330_Instr_LoadRfConfiguration(pDataParams, PHHAL_HW_NCx3330_RF_TX_NFC_AI_424_424, PHHAL_HW_NCx3330_RF_RX_NFC_AI_424));  /* Masking RxDataRate with Minimum Configuration Index */

        SET_NCx3330_SHADOW(wNcx3330_DefShadow_I18092m_424_Active);
        wTxDatarate = PHHAL_HW_RF_DATARATE_424;
        wRxDatarate = PHHAL_HW_RF_DATARATE_424;
        /* Enable active mode */
        pDataParams->bActiveMode = PH_ON;
    ...
    case PHHAL_HW_CARDTYPE_ISO15693:
        /* Use 15693 shadow */
        PH_CHECK_SUCCESS_FCT(statusTmp,phhalHw_Ncx3330_Instr_LoadRfConfiguration(pDataParams, PHHAL_HW_NCx3330_RF_TX_ISO15693_26_1OF4_ASK100, PHHAL_HW_NCx3330_RF_RX_ISO15693_26_1OF4_SC));  /* Masking RxDataRate with Minimum Configuration Index */
        SET_NCx3330_SHADOW(wNcx3330_DefaultShadow_I15693);
    ...
    case PHHAL_HW_CARDTYPE_I18000P3M3:
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp,phhalHw_Ncx3330_Instr_LoadRfConfiguration(pDataParams, PHHAL_HW_NCx3330_RF_TX_ISO180003M3_TARI_9_44_ASK, PHHAL_HW_NCx3330_RF_RX_ISO180003M3_MANCH424_2_PERIOD));  /* Masking RxDataRate with Minimum Configuration Index */

        SET_NCx3330_SHADOW(wNcx3330_DefaultShadow_I18000p3m3);
    ...
    if (0U != bUseDefaultShadow)
    {
        ...
        (void)memset(pDataParams->wCfgShadow, 0x00U, PHHAL_HW_NCx3330_SHADOW_COUNT);
        ...
        for (wIndex = 0U; wIndex < wShadowCount; ++wIndex)
        {
            ...
            {
                PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_SetConfig(pDataParams, wConfig, pDataParams->wCfgShadow[wConfig]));
            }
        }
...
phStatus_t phhalHw_Ncx3330_Exchange(
    phhalHw_Ncx3330_DataParams_t * pDataParams,
    uint16_t wOption,
    uint8_t * pTxBuffer,
    uint16_t wTxLength,
    ...
    )
{
    ...
    do
    {
        ...
        PH_CHECK_FAILURE_FCT(statusTmp, phhalHw_Ncx3330_GetTxBuffer(pDataParams, PH_ON, &pTmpBuffer, &wTmpBufferLen, &wTmpBufferSize));
        ...
        if(pDataParams->bJewelActivated == PH_ON)
        {
            ...
            /*PH_CHECK_FAILURE_FCT(statusTmp, phhalHw_Ncx3330_Instr_WriteRegisterOrMask( pDataParams, CRC_TX_CONFIG, CRC_TX_CONFIG_TX_CRC_BYTE2_ENABLE_MASK));*/
            ...
            PH_CHECK_FAILURE_FCT(statusTmp, phhalHw_Ncx3330_SetConfig(pDataParams, PHHAL_HW_CONFIG_PARITY, PH_OFF));

            /* Make sure CRC is OFF */
            PH_CHECK_FAILURE_FCT(statusTmp, phhalHw_Ncx3330_SetConfig(pDataParams, PHHAL_HW_CONFIG_TXCRC, PH_OFF));
            PH_CHECK_FAILURE_FCT(statusTmp, phhalHw_Ncx3330_SetConfig(pDataParams, PHHAL_HW_CONFIG_RXCRC, PH_OFF));
            PH_CHECK_FAILURE_FCT(statusTmp, phhalHw_Ncx3330_SetConfig(pDataParams, PHHAL_HW_CONFIG_TXLASTBITS, 7U));

            PH_CHECK_FAILURE_FCT(statusTmp, phhalHw_Ncx3330_Instr_WriteRegisterOrMask( pDataParams, TRANSCEIVER_CONFIG, TRANSCEIVER_CONFIG_TX_FRAMESTEP_ENABLE_MASK));
            PH_CHECK_FAILURE_FCT(statusTmp, phhalHw_Ncx3330_SetConfig(pDataParams, PHHAL_HW_CONFIG_TXWAIT_US,29));
        }

        if ((pDataParams->wTxBufStartPos == 0U))
        {
            pTmpBuffer[pDataParams->wTxBufStartPos++] = PHHAL_HW_NCx3330_SET_INSTR_SEND_DATA; /* Reserved 0th Location of buffer for Command code */
...
#ifndef NCx3330_P2P_HW_SYNC_BYTE
        ...
        {
            /*NCx3330 TxBuffer is 262 bytes including 2 byte command header*/
            statusTmp = (PH_ERR_BUFFER_OVERFLOW | PH_COMP_HAL);
            break;
        }

        /*Execute the Tranceive Command*/
        PH_CHECK_FAILURE_FCT(statusTmp, phhalHw_Ncx3330_Int_LoadCommand(pDataParams, PHHAL_HW_NCx3330_SYSTEM_TRANSEIVE_CMD));
        ...
        /* Clear Interrupts  */
        PH_CHECK_FAILURE_FCT(statusTmp, phhalHw_Ncx3330_Instr_WriteRegister(pDataParams, IRQ_SET_CLEAR, PHHAL_HW_NCx3330_IRQ_SET_CLEAR_ALL_MASK));

        (void)phOsal_EventClear(&pDataParams->HwEventObj.EventHandle, E_OS_EVENT_OPT_NONE, E_PH_OSAL_EVT_RF, NULL);

        /* Enable IRQ sources */
        PH_CHECK_FAILURE_FCT(statusTmp, phhalHw_Ncx3330_Instr_WriteRegister(pDataParams, IRQ_ENABLE, dwIrqWaitFor));
        ...
        if(pDataParams->bRxMultiple == PH_ON)
        {
            ...
            {
                dwValue |=PHHAL_HW_NCx3330_MS_TIMEOUT_PRESCALAR;
            }
            PH_CHECK_FAILURE_FCT(statusTmp, phhalHw_Ncx3330_Instr_WriteRegister(pDataParams, TIMER1_CONFIG, dwValue));
        }
        ...
        *(pTmpBuffer+1U) = (uint8_t)pDataParams->wCfgShadow[PHHAL_HW_CONFIG_TXLASTBITS];
        ...
        {
            PH_CHECK_FAILURE_FCT(statusTmp, phhalHw_Ncx3330_Instr_ReadRegister(pDataParams, RF_STATUS, &dwValue));
            if ((0U == ((dwValue & RF_STATUS_TX_RF_STATUS_MASK))))
            {
                /* field is turned ON */
                PH_CHECK_FAILURE_FCT(statusTmp, phhalHw_Ncx3330_FieldOff(pDataParams));
                PH_CHECK_FAILURE_FCT(statusTmp, phhalHw_Ncx3330_FieldOn(pDataParams));
            }
        }
    }while(FALSE);
    ...
    /* Send it to the chip */
    PH_CHECK_SUCCESS_FCT(statusTmp,phhalHw_Ncx3330_BalExchange(
        pDataParams,
        pTmpBuffer,
    ...
    {
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_SetConfig(pDataParams, PHHAL_HW_CONFIG_TXLASTBITS, 0x00U));
    }

    status  = phhalHw_Ncx3330_Receive_Int(pDataParams,dwIrqWaitFor,ppRxBuffer,pRxLength,PH_ON);

    if( (status & PH_ERR_MASK) != PH_ERR_SUCCESS)
    {
        /*load idle command*/
        statusTmp = phhalHw_Ncx3330_Int_IdleCommand(pDataParams);
    }

    if (pDataParams->bOpeMode != RD_LIB_MODE_EMVCO)
    {
        statusTmp = phhalHw_Ncx3330_Instr_WriteRegisterAndMask(pDataParams, TIMER1_CONFIG, (uint32_t)(~TIMER1_CONFIG_T1_ENABLE_MASK));
    }

    return status;
}

phStatus_t phhalHw_Ncx3330_FieldOn(
    phhalHw_Ncx3330_DataParams_t * pDataParams
    )
{
    ...
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_WriteRegisterOrMask(pDataParams, IRQ_SET_CLEAR, dwRegister));

    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_RfOn(pDataParams, bRFONconfig));      /* Field ON using Collision Avoidance option */

    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_ReadRegister(pDataParams, RF_STATUS, &dwRegister));
...
phStatus_t phhalHw_Ncx3330_FieldOff(
    phhalHw_Ncx3330_DataParams_t * pDataParams
    )
{
    phStatus_t PH_MEMLOC_REM statusTmp;
    ...
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_RfOff(pDataParams));
    return PH_ERR_SUCCESS;
}


phStatus_t phhalHw_Ncx3330_Wait(
    phhalHw_Ncx3330_DataParams_t * pDataParams,
    uint8_t bUnit,
    uint16_t wTimeout
    )
{
    ...
    {
        wFreq = PHHAL_HW_NCx3330_MIN_FREQ;
        wPrescaler = 0x3CU;
        while(wTimeout > PHHAL_HW_NCx3330_MAX_TIME_DELAY_MS)
        {
            wTimeout -= PHHAL_HW_NCx3330_MAX_TIME_DELAY_MS;
            /* Calculating the load value */
            dwLoadValue =(uint32_t) (  PHHAL_HW_NCx3330_MAX_TIME_DELAY_MS * ( wFreq  / PHHAL_HW_NCx3330_CONVERSION_MS_SEC) );
            PH_CHECK_SUCCESS_FCT(statusTmp,phhalHw_Ncx3330_Int_Wait( pDataParams, dwLoadValue,  wPrescaler));
        }

        dwLoadValue =(uint32_t) (  wTimeout * ( wFreq  / PHHAL_HW_NCx3330_CONVERSION_MS_SEC) );
        PH_CHECK_SUCCESS_FCT(statusTmp,phhalHw_Ncx3330_Int_Wait( pDataParams, dwLoadValue,  wPrescaler));
    }
    else
    {
        /* here wTimeout will be in uS and not be Zero */
        wFreq = PHHAL_HW_NCx3330_MAX_FREQ;
        wPrescaler = 0x00U;
        /*Reducing the division by 2 digits to retain the 2 digit decimal places which were getting wiped out*/
        dwLoadValue =(uint32_t) ( wFreq / (PHHAL_HW_NCx3330_CONVERSION_US_SEC/100));
...
phStatus_t phhalHw_Ncx3330_FieldReset(
    phhalHw_Ncx3330_DataParams_t * pDataParams
    )
{
    phStatus_t  PH_MEMLOC_REM statusTmp;
    ...
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_FieldOff(pDataParams));

    /* wait for field-off time-out */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Wait(
        pDataParams,
        PHHAL_HW_TIME_MILLISECONDS,
        (pDataParams->wFieldOffTime)));

    /* switch on the field again */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_FieldOn(pDataParams));
...
phStatus_t phhalHw_Ncx3330_SetConfig(
    phhalHw_Ncx3330_DataParams_t * pDataParams,
    uint16_t wConfig,
    uint16_t wValue
    )
{
    ...
    switch(wConfig)
    {
    case PHHAL_HW_NCx3330_CONFIG_SET_FELICA_EMD:
    case PHHAL_HW_NCx3330_CONFIG_SET_FELICA_EMD_LEN_CHECK:
    case PHHAL_HW_NCx3330_CONFIG_SET_FELICA_EMD_RC_CHECK:
    case PHHAL_HW_NCx3330_CONFIG_SET_FELICA_EMD_PROTOCOL_ERR_CHECK:
    case PHHAL_HW_NCx3330_CONFIG_SET_FELICA_EMD_INTEGRITY_ERR_CHECK:
    case PHHAL_HW_NCx3330_CONFIG_SET_FELICA_EMD_LEN_BYTE_MIN:
    case PHHAL_HW_NCx3330_CONFIG_SET_FELICA_EMD_LEN_BYTE_MAX:
    case PHHAL_HW_NCx3330_CONFIG_SET_FELICA_EMD_RC_BYTE_VAL:
    ...
    case PHHAL_HW_CONFIG_ASK100:
        ...
        if( pDataParams->wCfgShadow[wConfig] != wValue)
        {
            ...
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_SetConfig_Int(pDataParams, wConfig, wValue));
    ...
    case PHHAL_HW_CONFIG_RXALIGN:
        if ((pDataParams->wCfgShadow[wConfig] != wValue) || (pDataParams->bOpeMode != RD_LIB_MODE_EMVCO))
        {
            ...
            wRegTypeValueSets[wSizeOfRegTypeValueSets++] = PHHAL_HW_NCx3330_WRITE_MULTIPLE_TYPE_WRITE_AND_MASK;
            ...
            wRegTypeValueSets[wSizeOfRegTypeValueSets++] = CRC_RX_CONFIG;
            wRegTypeValueSets[wSizeOfRegTypeValueSets++] = PHHAL_HW_NCx3330_WRITE_MULTIPLE_TYPE_WRITE_OR_MASK;
            wRegTypeValueSets[wSizeOfRegTypeValueSets++] = (uint8_t)(dwTemp);
            wRegTypeValueSets[wSizeOfRegTypeValueSets++] = (uint8_t)(dwTemp>>8U);
            wRegTypeValueSets[wSizeOfRegTypeValueSets++] = (uint8_t)(dwTemp>>16U);
            wRegTypeValueSets[wSizeOfRegTypeValueSets++] = (uint8_t)(dwTemp>>24U);
            ...
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_WriteRegisterMultiple(pDataParams, wRegTypeValueSets, wSizeOfRegTypeValueSets));
    ...
    case PHHAL_HW_CONFIG_CLEARBITSAFTERCOLL:
        ...
        if (pDataParams->wCfgShadow[wConfig] != wValue)
        {
            ...
            if (wValue == PH_OFF)
            {
                PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_WriteRegisterOrMask(pDataParams, CRC_RX_CONFIG, CRC_RX_CONFIG_VALUES_AFTER_COLLISION_MASK));
            }
            else
            {
                PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_WriteRegisterAndMask(pDataParams, CRC_RX_CONFIG, (0xFFFFFFFFU^CRC_RX_CONFIG_VALUES_AFTER_COLLISION_MASK)));
            }
            pDataParams->wCfgShadow[wConfig] = wValue;
        }
        break;
    ...
    case PHHAL_HW_CONFIG_TXWAIT_MS:
        ...
        /* Set TxWait */
        fTime = 0.0;
        dwValue = PHHAL_HW_NCx3330_TR_RX_PRESCALAR;
        dwTemp = wValue*1000U;
        if(0U != dwTemp)
        {
            ...
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_WriteRegister(pDataParams, TX_WAIT_CONFIG, dwValue));
        }
        else
        {
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_WriteRegister(pDataParams, TX_WAIT_CONFIG, dwValue));
    ...
    case PHHAL_HW_CONFIG_RXWAIT_US:
        ...
        if ((pDataParams->wCfgShadow[wConfig] != wValue) || (pDataParams->bOpeMode != RD_LIB_MODE_EMVCO))
        {
            ...
            if(0U != dwTemp)
            {
                ...
                PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_WriteRegister(pDataParams, RX_WAIT_CONFIG, dwValue ));
            }
            else
            {
                PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_WriteRegister(pDataParams, RX_WAIT_CONFIG, dwValue ));
    ...
    case PHHAL_HW_CONFIG_DISABLE_MF_CRYPTO1:
        ...
        {
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_WriteRegisterAndMask(pDataParams, SYSTEM_CONFIG, (uint32_t)(~(SYSTEM_CONFIG_MFC_CRYPTO_ON_MASK))));
            pDataParams->bMfcCryptoEnabled = PH_OFF;
        }
        break;
    ...
    case PHHAL_HW_CONFIG_TXBUFFER_OFFSET:
        ...
        pDataParams->wAdditionalInfo = wValue + PHHAL_HW_NCx3330_EXCHANGE_HEADER_SIZE;
#ifndef NCx3330_P2P_HW_SYNC_BYTE
        if(pDataParams->bNfcipMode == PH_ON)
        {
    ...
    case PHHAL_HW_CONFIG_RXBUFFER_STARTPOS:
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_GetRxBuffer(pDataParams, PH_ON, &pBuffer, &wBufferLen, &wBufferSize));
    ...
    case PHHAL_HW_CONFIG_TXBUFFER_LENGTH:
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_GetTxBuffer(pDataParams, PH_ON, &pBuffer, &wBufferLen, &wBufferSize));
    ...
    case PHHAL_HW_CONFIG_TXDATARATE_FRAMING:
        ...
        if ((pDataParams->wCfgShadow[wConfig] != wValue) || (pDataParams->bOpeMode != RD_LIB_MODE_EMVCO))
        {
            ...
            else
            {
                ...
                PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_SetCardMode(
                    pDataParams,
                    wValue,
            ...
            {
                PH_CHECK_SUCCESS_FCT(statusTmp,  phhalHw_Ncx3330_Instr_WriteRegister(pDataParams, TX_SYMBOL23_MOD_RFU, (uint32_t)PHHAL_HW_15693_TX26_SYMBOL23));
                PH_CHECK_SUCCESS_FCT(statusTmp,  phhalHw_Ncx3330_Instr_WriteRegister(pDataParams, TX_DATA_MOD_RFU, (uint32_t)PHHAL_HW_15693_TX26_DATA_MOD));
            }
            else if((pDataParams->bCardType == PHHAL_HW_CARDTYPE_ISO15693) && (wTmpValue == PHHAL_HW_RF_I15693_53KBPS_DATARATE))
            {
                PH_CHECK_SUCCESS_FCT(statusTmp,  phhalHw_Ncx3330_Instr_WriteRegister(pDataParams, TX_SYMBOL23_MOD_RFU, (uint32_t)PHHAL_HW_15693_TX53_SYMBOL23));
                PH_CHECK_SUCCESS_FCT(statusTmp,  phhalHw_Ncx3330_Instr_WriteRegister(pDataParams, TX_DATA_MOD_RFU, (uint32_t)PHHAL_HW_15693_TX53_DATA_MOD));
            ...
            {
                PH_CHECK_SUCCESS_FCT(statusTmp,  phhalHw_Ncx3330_Instr_WriteRegister(pDataParams, TX_SYMBOL23_MOD_RFU, (uint32_t)PHHAL_HW_15693_TX106_SYMBOL23));
                PH_CHECK_SUCCESS_FCT(statusTmp,  phhalHw_Ncx3330_Instr_WriteRegister(pDataParams, TX_DATA_MOD_RFU, (uint32_t)PHHAL_HW_15693_TX106_DATA_MOD));
                pDataParams->wCfgShadow[wConfig] = wTmpValue;
            }
            else if((pDataParams->bCardType == PHHAL_HW_CARDTYPE_ISO15693) && (wTmpValue == PHHAL_HW_RF_DATARATE_212))
            {
                PH_CHECK_SUCCESS_FCT(statusTmp,  phhalHw_Ncx3330_Instr_WriteRegister(pDataParams, TX_SYMBOL23_MOD_RFU, (uint32_t)PHHAL_HW_15693_TX212_SYMBOL23));
                PH_CHECK_SUCCESS_FCT(statusTmp,  phhalHw_Ncx3330_Instr_WriteRegister(pDataParams, TX_DATA_MOD_RFU, (uint32_t)PHHAL_HW_15693_TX212_DATA_MOD));
                pDataParams->wCfgShadow[wConfig] = wTmpValue;
            }
            else
            {
    ...
    case PHHAL_HW_CONFIG_RXDATARATE_FRAMING:
        ...
        if ((pDataParams->wCfgShadow[wConfig] != wValue) || (pDataParams->bOpeMode != RD_LIB_MODE_EMVCO))
        {
            ...
            {
                PH_CHECK_SUCCESS_FCT(statusTmp,  phhalHw_Ncx3330_Instr_ReadRegister(pDataParams, SIGPRO_CONFIG, &dwTemp));
                dwTemp = dwTemp & PHHAL_HW_15693_RX106_BAUDRATE_MASK;
                dwTemp = dwTemp | PHHAL_HW_15693_RX106_BAUDRATE_VALUE;
                PH_CHECK_SUCCESS_FCT(statusTmp,  phhalHw_Ncx3330_Instr_WriteRegister(pDataParams, SIGPRO_CONFIG, (uint32_t)dwTemp));

                PH_CHECK_SUCCESS_FCT(statusTmp,  phhalHw_Ncx3330_Instr_ReadRegister(pDataParams, SIGPRO_RM_CONFIG, &dwTemp));
                dwTemp = dwTemp & PHHAL_HW_15693_RX106_CORRSPEED;
                PH_CHECK_SUCCESS_FCT(statusTmp,  phhalHw_Ncx3330_Instr_WriteRegister(pDataParams, SIGPRO_RM_CONFIG, (uint32_t)dwTemp));
    ...
    case PHHAL_HW_CONFIG_SET_EMD:
        ...
        if(wValue == 0x1U)
        {
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_WriteRegister(pDataParams, EMD_CONTROL,PHHAL_HW_NCx3330_EMD_2P5));
        }
        else
        {
            /* Clear EMD Enable bit in EMD Control Register */
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_WriteRegisterAndMask(pDataParams, EMD_CONTROL, (uint32_t)~EMD_CONTROL_EMD_ENABLE_MASK));
        }
        break;

    case PHHAL_HW_CONFIG_SETMINFDT:

        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_SetMinFDT(pDataParams, wValue));
        break;
    ...
    case PHHAL_HW_CONFIG_RXMULTIPLE:
        ...
        if (wValue == PH_ON)
        {
            ...
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_WriteRegisterOrMask( pDataParams, TRANSCEIVER_CONFIG, TRANSCEIVER_CONFIG_RX_MULTIPLE_ENABLE_MASK ));
        }
        else
        {
            pDataParams->bRxMultiple = PH_OFF;
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_WriteRegisterAndMask( pDataParams, TRANSCEIVER_CONFIG, (uint32_t )~(TRANSCEIVER_CONFIG_RX_MULTIPLE_ENABLE_MASK) ));
        }
        break;
    ...
    case PHHAL_HW_CONFIG_RFON_INTERRUPT:
        ...
        if(wValue == PH_ON)
        {
            ...
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_WriteRegister(pDataParams, IRQ_ENABLE, IRQ_ENABLE_RFON_DET_IRQ_SET_ENABLE_MASK));
        }
        else
        {
            /* Disable RF-ON Interrupt*/
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_WriteRegisterAndMask(pDataParams, IRQ_ENABLE,  ~(uint32_t)IRQ_ENABLE_RFON_DET_IRQ_SET_ENABLE_MASK));
        }
        break;
...
#ifdef  NCx3330_P2P_HW_SYNC_BYTE
        if (pDataParams->bNfcipMode == PH_ON)
        {
            phhalHw_Ncx3330_AutoSyncByte(pDataParams);
        }
#endif
        break;
    ...
    case PHHAL_HW_CONFIG_SET_SYMBOL_SEND:
        ...
        if (wValue == PH_ON)
        {
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_WriteRegisterAndMask(pDataParams, TX_CONFIG,  ~(uint32_t)TX_CONFIG_TX_DATA_ENABLE_MASK));
        }
        /* PH_OFF implies Setting Bit-3 (DataEn Bit in TxDataNum). */
        else
        {
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_WriteRegisterOrMask(pDataParams, TX_CONFIG, TX_CONFIG_TX_DATA_ENABLE_MASK));
        }
        break;
    ...
    case PHHAL_HW_CONFIG_CRCTYPE:
        ...
        * So flag is enable to perform software calculation of CRC5 in Ncx3330 HAL
        */
    ...
    case PHHAL_HW_CONFIG_MFHALTED:
        ...
        {
            PH_CHECK_SUCCESS_FCT(statusTmp,
                phhalHw_Ncx3330_Instr_WriteRegisterOrMask(pDataParams, SYSTEM_CONFIG, SYSTEM_CONFIG_AUTOCOLL_STATE_A_MASK));
           pDataParams->bCardMode  = PH_ON;
        }
        else
        {
            PH_CHECK_SUCCESS_FCT(statusTmp,
                phhalHw_Ncx3330_Instr_WriteRegisterAndMask(pDataParams, SYSTEM_CONFIG, (uint32_t)~SYSTEM_CONFIG_AUTOCOLL_STATE_A_MASK));
            pDataParams->bCardMode  = PH_OFF;
    ...
    case PHHAL_HW_CONFIG_POLL_GUARD_TIME_US:
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phDriver_TimerStart(PH_DRIVER_TIMER_MICRO_SECS, wValue,
                phhalHw_Ncx3330_GuardTimeCallBck));
        break;
    ...
    case PHHAL_HW_NCx3330_CONFIG_SET_FELICA_EMD:
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp,
            phhalHw_Ncx3330_SetConfig_FelicaEmdRegBit(pDataParams, wValue, (uint32_t)FELICA_EMD_CONTROL_FELICA_EMD_ENABLE_MASK));
        break;

    case PHHAL_HW_NCx3330_CONFIG_SET_FELICA_EMD_LEN_CHECK:
        /* Configure EMD length byte check enable bit in FELICA_EMD_CONTROL Register and shadow register */
        PH_CHECK_SUCCESS_FCT(statusTmp,
            phhalHw_Ncx3330_SetConfig_FelicaEmdRegBit(pDataParams, wValue, (uint32_t)FELICA_EMD_CONTROL_FELICA_EMD_LEN_CHECK_ENABLE_MASK));
        break;

    case PHHAL_HW_NCx3330_CONFIG_SET_FELICA_EMD_RC_CHECK:
        /* Configure RC byte check enable bit in FELICA_EMD_CONTROL Register and shadow register */
        PH_CHECK_SUCCESS_FCT(statusTmp,
            phhalHw_Ncx3330_SetConfig_FelicaEmdRegBit(pDataParams, wValue, (uint32_t)FELICA_EMD_CONTROL_FELICA_EMD_RC_CHECK_ENABLE_MASK));
        break;

    case PHHAL_HW_NCx3330_CONFIG_SET_FELICA_EMD_PROTOCOL_ERR_CHECK:
        /* Configure Protocol error check enable bit in FELICA_EMD_CONTROL Register and shadow register */
        PH_CHECK_SUCCESS_FCT(statusTmp,
            phhalHw_Ncx3330_SetConfig_FelicaEmdRegBit(pDataParams, wValue, (uint32_t)FELICA_EMD_CONTROL_FELICA_EMD_PROTOCOL_ERR_CHECK_ENABLE_MASK));
        break;

    case PHHAL_HW_NCx3330_CONFIG_SET_FELICA_EMD_INTEGRITY_ERR_CHECK:
        /* Configure Integrity error check enable bit in FELICA_EMD_CONTROL Register and shadow register */
        PH_CHECK_SUCCESS_FCT(statusTmp,
            phhalHw_Ncx3330_SetConfig_FelicaEmdRegBit(pDataParams, wValue, (uint32_t)FELICA_EMD_CONTROL_FELICA_EMD_INTEGRITY_ERR_CHECK_ENABLE_MASK));
        break;

    case PHHAL_HW_NCx3330_CONFIG_SET_FELICA_EMD_LEN_BYTE_MIN:
        /* Configure min length byte value in FELICA_EMD_CONTROL Register and shadow register */
        PH_CHECK_SUCCESS_FCT(statusTmp,
            phhalHw_Ncx3330_SetConfig_FelicaEmdRegByte(
                pDataParams,
                wValue,
...
phStatus_t phhalHw_Ncx3330_GetConfig(
    phhalHw_Ncx3330_DataParams_t * pDataParams,
    uint16_t wConfig,
    uint16_t * pValue
    )
{
    ...
    case PHHAL_HW_CONFIG_EXT_RF_ON:
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp,
            phhalHw_Ncx3330_Instr_ReadRegister(pDataParams, RF_STATUS, &dwRegister));
        ...
        if (0U != (dwRegister & RF_STATUS_RF_DET_STATUS_MASK))
        {
            ...
            PH_CHECK_SUCCESS_FCT(statusTmp,
                phhalHw_Ncx3330_Instr_WriteRegister(pDataParams, IRQ_SET_CLEAR, dwRegister));
        }
    ...
    {
        PH_CHECK_SUCCESS_FCT(statusTmp,
            phhalHw_Ncx3330_Instr_ReadRegister(pDataParams, SYSTEM_CONFIG, &dwRegister));
...
phStatus_t phhalHw_Ncx3330_MfcAuthenticateKeyNo(
    phhalHw_Ncx3330_DataParams_t * pDataParams,
    uint8_t bBlockNo,
    uint8_t bKeyType,
    uint16_t wKeyNo,
    ...
    )
{
    ...
    return phhalHw_Ncx3330_MfcAuthenticate(pDataParams, bBlockNo, bKeyType, pKey, pUid);
...
phStatus_t phhalHw_Ncx3330_MfcAuthenticate(
    phhalHw_Ncx3330_DataParams_t * pDataParams,
    uint8_t bBlockNo,
    uint8_t bKeyType,
    uint8_t * pKey,
    ...
    )
{
    ...
    status = phhalHw_Ncx3330_Instr_MifareAuthenticate(
        pDataParams,
        pKey,
        bKeyType,
        bBlockNo,
    ...
    {   /* If status is other than success load idle command */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Int_IdleCommand(pDataParams));
    }
...
phStatus_t phhalHw_Ncx3330_SetMinFDT(
    phhalHw_Ncx3330_DataParams_t * pDataParams,
    uint16_t wValue
    )
{
    ...
    if (wValue == PH_ON)
    {
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_GetConfig(pDataParams,
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_SetConfig(pDataParams,
...
phStatus_t phhalHw_Ncx3330_Transmit(
    phhalHw_Ncx3330_DataParams_t * pDataParams,   /**< [In] Pointer to this layer's parameter structure. */
    ...
    )
{
    ...
    *  since the data to transmit would get overwritten by received data. */
    ...
    if((pDataParams->wTargetMode != PH_OFF))
    {
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_ReadRegister(pDataParams,RF_STATUS, &dwRegValue));
        dwTrasceiveState = (dwRegValue& RF_STATUS_TRANSCEIVE_STATE_MASK) >> RF_STATUS_TRANSCEIVE_STATE_POS;
        if (dwTrasceiveState  !=PHHAL_HW_NCx3330_TRANCEIVE_STATE_WAITTRANSMIT )
        {
            return PH_ADD_COMPCODE_FIXED(PH_ERR_INTERNAL_ERROR, PH_COMP_HAL);
        }
    }

    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_GetTxBuffer(pDataParams, PH_ON, &pTmpBuffer, &wTmpBufferLen, &wTmpBufferSize));
    ...
    if (0U != ( PH_TRANSMIT_PREV_FRAME & wOption ))
    {
        ...
        else
        {
            ...
            {
                /* Include the NCx3330 Instruction Header Bytes len  */
                pDataParams->wTxBufStartPos = PHHAL_HW_NCx3330_EXCHANGE_HEADER_SIZE;
#ifndef NCx3330_P2P_HW_SYNC_BYTE
                if(pDataParams->bNfcipMode == PH_ON)
                {
    ...
    if((pDataParams->wTargetMode == PH_OFF))
    {
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_ReadRegister(pDataParams,RF_STATUS, &dwRegValue));
        dwTrasceiveState = (dwRegValue& RF_STATUS_TRANSCEIVE_STATE_MASK) >> RF_STATUS_TRANSCEIVE_STATE_POS;
        if((dwTrasceiveState > PHHAL_HW_NCx3330_TRANCEIVE_STATE_WAITTRANSMIT) || (dwTrasceiveState == PHHAL_HW_NCx3330_TRANCEIVE_STATE_IDLE))
        {
            /*load idle command*/
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Int_IdleCommand(pDataParams));
            /*Execute the Tranceive Command*/
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Int_LoadCommand(pDataParams, PHHAL_HW_NCx3330_SYSTEM_TRANSEIVE_CMD));
    ...
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_WriteRegister(pDataParams, IRQ_SET_CLEAR, PHHAL_HW_NCx3330_IRQ_SET_CLEAR_ALL_MASK));

    (void)phOsal_EventClear(&pDataParams->HwEventObj.EventHandle, E_OS_EVENT_OPT_NONE, E_PH_OSAL_EVT_RF, NULL);

    /* Enable IRQ sources */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_WriteRegister(pDataParams, IRQ_ENABLE, dwIrqWaitFor));
    ...
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_ReadRegister(pDataParams, RF_STATUS, &dwValue));
    ...
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_WaitIrq( pDataParams,
    ...
    if( status != PH_ERR_SUCCESS)
    {
        /*load idle command*/
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Int_IdleCommand(pDataParams));
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_WriteRegisterAndMask( pDataParams, TIMER1_CONFIG, (uint32_t)(~TIMER1_CONFIG_T1_ENABLE_MASK)));
    }
...
phStatus_t phhalHw_Ncx3330_Receive(
    phhalHw_Ncx3330_DataParams_t * pDataParams,     /**< [In]  Pointer to this layer's parameter structure. */
    uint16_t wOption,                              /**< [In]  Option parameter. */
    ...
    )
{
    ...
    do
    {
        ...
        if(pDataParams->bTransmited == PH_OFF)
        {
            ...
            /* Check for Transceive state before loading the Transceiver command not equal to PHHAL_HW_NCx3330_TRANCEIVE_STATE_WAITRECEIVE or PHHAL_HW_NCx3330_TRANCEIVE_STATE_WAITFORDATA */

            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_ReadRegister(pDataParams,RF_STATUS, &dwRegister));
            dwTranceiveState = ((dwRegister & RF_STATUS_TRANSCEIVE_STATE_MASK)>>RF_STATUS_TRANSCEIVE_STATE_POS);

            if((dwTranceiveState == PHHAL_HW_NCx3330_TRANCEIVE_STATE_IDLE) \
                || (dwTranceiveState != PHHAL_HW_NCx3330_TRANCEIVE_STATE_WAITFORDATA))
            {
                /*Load Idle Command*/
                PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Int_IdleCommand(pDataParams));

                PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_WriteRegisterAndMask(pDataParams, TRANSCEIVER_CONFIG, (uint32_t)(~TRANSCEIVER_CONFIG_INITIATOR_MASK)));
            ...
            if((pDataParams->bActiveMode == PH_ON) && (pDataParams->wTargetMode != PH_OFF))
            {
                ...
                PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_WriteRegisterAndMask(pDataParams, SYSTEM_CONFIG,(uint32_t)~SYSTEM_CONFIG_ACTIVE_MODE_TX_RF_ENABLE_MASK));
                ...
                {
                    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_WriteRegisterOrMask(pDataParams, SYSTEM_CONFIG,SYSTEM_CONFIG_ACTIVE_MODE_TX_RF_ENABLE_MASK));
                }
        ...
        else
        {
            ...
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_ReadRegister(pDataParams, IRQ_STATUS, &dwRegister));
            ...
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_WriteRegister(pDataParams, IRQ_SET_CLEAR, dwIrqClear ));
        }
    ...
    }while((status & PH_ERR_MASK)  == PHHAL_HW_NCx3330_ACTIVE_ERR_CAUSE4);
...
phStatus_t phhalHw_Ncx3330_BalExchange(
                                      phhalHw_Ncx3330_DataParams_t * pDataParams,
                                      uint8_t * pTxBuffer,
                                      uint16_t wTxLength,
                                      uint16_t wRxBufSize,
                                      ...
                                      )
{
    ...
    else
    {
        ...
        phhalHw_Ncx3330_WriteSSEL(pDataParams->pBalDataParams, PH_DRIVER_SET_LOW);
        ...
        phhalHw_Ncx3330_WriteSSEL(pDataParams->pBalDataParams, PH_DRIVER_SET_HIGH);
#endif
...
phStatus_t phhalHw_Ncx3330_Autocoll(
    phhalHw_Ncx3330_DataParams_t * pDataParams,
    uint16_t wMode,
    uint8_t ** ppRxBuffer,
    uint16_t * pRxLength,
    ...
    )
{
    ...
    {
        bRfTechnology = PHHAL_HW_NCx3330_AUTOCOLL_RF_TECHNOLOGY_MASK_NFC_A;
    }
    else
    {
        /*RFTech A*/
        ...
        {
            bRfTechnology |= PHHAL_HW_NCx3330_AUTOCOLL_RF_TECHNOLOGY_MASK_NFC_F;
        }
        /*RFTech Active A*/
        if((wMode & ACTIVE_A_MODE) == ACTIVE_A_MODE)
        {
            bRfTechnology |= PHHAL_HW_NCx3330_AUTOCOLL_RF_TECHNOLOGY_MASK_ISO18092_ACTIVE;
        }
        /*RFTech Active F*/
        if((wMode & ACTIVE_F_MODE) == ACTIVE_F_MODE)
        {
            bRfTechnology |= PHHAL_HW_NCx3330_AUTOCOLL_RF_TECHNOLOGY_MASK_NFC_F_ACTIVE;
        }
    ...
    *pRxLength = 0U;
    ...
    /*Go to autocoll mode*/
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_SwitchModeAutocoll(pDataParams, bRfTechnology, bAutocollMode ) );

    /* Wait for Interrupt to occur */
    statusTmp =  phhalHw_Ncx3330_WaitIrq( pDataParams, PH_ON, PH_OFF, dwIrqWaitFor, &dwIrqReg);

    if((statusTmp & PH_ERR_MASK) == PH_ERR_ABORTED)
    {
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_SwitchModeNormal(pDataParams) );
    ...
    else if (0U != (dwIrqReg & IRQ_STATUS_RX_IRQ_MASK))
    {
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_ReadRegisterMultiple(pDataParams, pRegisters, 4U, &pTmpBuffer));
        ...
        bSpeed -= PHHAL_HW_NCx3330_SIGPRO_GENERAL_MAPPING;
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp,  phhalHw_Ncx3330_ReadData(pDataParams, ppRxBuffer, pRxLength));
        ...
        if(0U != (dwIrqReg & IRQ_STATUS_CARD_ACTIVATED_IRQ_MASK))
        {
            ...
            /* Disable active mode */
            pDataParams->bActiveMode = PH_OFF;
            if((bSpeed == PHHAL_HW_RF_DATARATE_106) && (**ppRxBuffer == PHHAL_HW_NCx3330_I18092MT_START_BYTE))
            {
        ...
        else if ((dwRfStatus & RF_STATUS_RF_DET_STATUS_MASK) == 0U)
        {
            ...
            bFraming = PHHAL_HW_NCx3330_BIT_ISO18092;
        }
        else
        {
            /* Terminate Autocoll command before existing. */
        ...
        if(bFraming == PHHAL_HW_NCx3330_BIT_MIFARE)
        {
            *pProtParams = PHHAL_HW_RF_TYPE_A_FRAMING | bSpeed;
        }
        else if(bFraming == PHHAL_HW_NCx3330_BIT_ISO18092)
        {
            *pProtParams = PHHAL_HW_RF_TYPE_ACTIVE_FRAMING | bSpeed;
        }
        else if(bFraming == PHHAL_HW_NCx3330_BIT_FELICA)
        {
            *pProtParams = PHHAL_HW_RF_TYPE_F_FRAMING | bSpeed;
        }
        else
        {
            /* Invalid Framing as NCx3330 will not emulate other than Type-A, Type-F and Active Frame */
...
phStatus_t phhalHw_Ncx3330_Lpcd(
    phhalHw_Ncx3330_DataParams_t * pDataParams)
{
    phStatus_t  PH_MEMLOC_REM statusTmp;
    uint32_t    PH_MEMLOC_REM dwRegister;
    ...
    {
    case PHHAL_HW_NCx3330_LPCD_MODE_DEFAULT:

        /*Get the current AGC measurement*/
        PH_CHECK_SUCCESS_FCT(statusTmp,  phhalHw_Ncx3330_Instr_ReadRegister( pDataParams, AGC_REF_CONFIG, &dwRegister));

        PH_CHECK_SUCCESS_FCT(statusTmp,  phhalHw_Ncx3330_Instr_ReadE2Prom( pDataParams, PHHAL_HW_NCx3330_LPCD_REFERENCE_VALUE_ADDR, bEPromData,  5U));

        PH_CHECK_SUCCESS_FCT(statusTmp,  phhalHw_Ncx3330_Instr_ReadE2Prom( pDataParams, PHHAL_HW_NCx3330_OCPROT_CONTROL_ADDR, bOcProtControl,  1U));
    ...
    case PHHAL_HW_NCx3330_LPCD_MODE_POWERDOWN:
        dwIrqWaitFor = (IRQ_STATUS_LPCD_IRQ_MASK | IRQ_STATUS_GENERAL_ERROR_IRQ_MASK);

        /* Clear above Interrupts  */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_WriteRegister(pDataParams, IRQ_SET_CLEAR, dwIrqWaitFor));
        (void)phOsal_EventClear(&pDataParams->HwEventObj.EventHandle, E_OS_EVENT_OPT_NONE, E_PH_OSAL_EVT_RF, NULL);

        /* Enable IRQ sources */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_WriteRegister(pDataParams, IRQ_ENABLE, dwIrqWaitFor));

        PH_CHECK_SUCCESS_FCT(statusTmp,  phhalHw_Ncx3330_Instr_SwitchModeLpcd(
            pDataParams,
            (uint16_t)(pDataParams->wWakeupCounterInMs))
            );

        /* Now wait for the IRQ */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_WaitIrq(
            pDataParams,
            PH_ON,
            PH_OFF,
            dwIrqWaitFor,
...
phStatus_t phhalHw_Ncx3330_SetListenParameters(
    phhalHw_Ncx3330_DataParams_t * pDataParams,
    uint8_t * pSensRes,
    uint8_t * pNfcId1,
    uint8_t SelRes,
...
{
    uint8_t PH_MEMLOC_BUF aCmd[PHHAL_HW_NCx3330_SET_LISTEN_LEN];
    if(0U != bNfcId3)
    {
        /*Coverity*/;
    }

    (void)memcpy(&aCmd[0], pSensRes, PHHAL_HW_NCx3330_SET_LISTEN_SENRES_LEN);
    (void)memcpy(&aCmd[2], pNfcId1, PHHAL_HW_NCx3330_SET_LISTEN_NFCID1_LEN);
    (void)memcpy(&aCmd[5], &SelRes, PHHAL_HW_NCx3330_SET_LISTEN_SELRES_LEN);
    (void)memcpy(&aCmd[6], pPollingResp, PHHAL_HW_NCx3330_SET_LISTEN_POLLRES_LEN);

    return phhalHw_Ncx3330_Instr_WriteE2Prom(pDataParams, PHHAL_HW_NCx3330_SET_LISTEN_EEPROM_ADDR, aCmd, PHHAL_HW_NCx3330_SET_LISTEN_LEN);
}


phStatus_t phhalHw_Ncx3330_AsyncAbort(
    phhalHw_Ncx3330_DataParams_t * pDataParams
    )
{
...
phStatus_t phhalHw_Ncx3330_I18000p3m3Inventory(phhalHw_Ncx3330_DataParams_t * pDataParams,
    ...
    )
{
    ...
    /* Enable IRQ sources */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_WriteRegisterOrMask(pDataParams, IRQ_ENABLE, dwIrqWaitFor));
    ...
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_EpcGen2Inventory(
        pDataParams,
        pSelCmd,
        bSelCmdLen,
    ...
    if (0U != (dwIrqReg & IRQ_STATUS_RX_IRQ_MASK))
    {
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_EpcGen2RetrieveResultSize( pDataParams, &ResultSize));
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_EpcGen2RetrieveResult( pDataParams, ppRxBuffer, ResultSize));
        ...
        *wRxBufferLen = ResultSize;
        if(ResultSize > 0U)
        {
             ...
             * all other values indicate response availability.(As specified in NCx3330 Instruction Layer document) */
...
phStatus_t phhalHw_Ncx3330_18000p3m3ResumeInventory(
    phhalHw_Ncx3330_DataParams_t * pDataParams,  /**< [In] Pointer to this layer's parameter structure. */
    uint8_t ** ppRxBuffer,                      /**< [In] Pointer to HAL Rx Buffer containing response from single/multiple tags. */
    uint16_t * wRxBufferLen                     /**< [In] Length of response in hal Rx Buffer. */
    )
{
    ...
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_EpcGen2ResumeInventory(pDataParams));
...
phStatus_t phhalHw_Ncx3330_EventWait(phhalHw_Ncx3330_DataParams_t * pDataParams, uint32_t dwEventTimeout)
{
...
phStatus_t phhalHw_Ncx3330_EventConsume(phhalHw_Ncx3330_DataParams_t * pDataParams)
{
...
phStatus_t phhalHw_Ncx3330_DeInit(
    phhalHw_Ncx3330_DataParams_t * pDataParams
    )
{
    phStatus_t PH_MEMLOC_REM statusTmp;
    ...
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3330_Instr_WriteRegisterAndMask(pDataParams, IRQ_ENABLE, (uint32_t)~0x0FFFFU));
...
static void phhalHw_Ncx3330_Reset(void)
{
    ...
    /* delay of ~2 ms */
    phDriver_TimerStart(PH_DRIVER_TIMER_MILLI_SECS, PHHAL_HW_NCx3330_RESET_DELAY_MILLI_SECS, NULL);
...
#endif  /* NXPBUILD__PHHAL_HW_NCx3330 */
