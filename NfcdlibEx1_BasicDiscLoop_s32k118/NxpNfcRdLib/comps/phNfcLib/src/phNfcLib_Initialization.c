...
phNfcLib_Status_t phNfcLib_Init(void)
{
    ...
    if (((phNfcLib_StateMachine_t)gphNfcLib_State.bNfcLibState) == eNfcLib_ResetState)
    {
        do
        {
            ...
            /* Initialize the NCx3320 HAL component */
            PH_CHECK_SUCCESS_FCT(wStatus, phhalHw_Ncx3320_Init(
                &gphNfcLib_Params.sHal,
                (uint16_t)(sizeof(phhalHw_Ncx3320_DataParams_t)),
                gphNfcLib_Params.pBal,
                (uint8_t *)gkphhalHw_Ncx3320_LoadConfig,
            ...
            /* Initialize the Ncx3330 HAL component */
            PH_CHECK_SUCCESS_FCT(wStatus, phhalHw_Ncx3330_Init(
                &gphNfcLib_Params.sHal,
                (uint16_t)(sizeof(phhalHw_Ncx3330_DataParams_t)),
                gphNfcLib_Params.pBal,
