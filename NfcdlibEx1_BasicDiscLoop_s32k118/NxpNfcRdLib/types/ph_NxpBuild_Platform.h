...
#if defined(PHDRIVER_LPC1769NCx3330_BOARD) \
    || defined(PHDRIVER_FRDM_K82FNCx3330_BOARD)
#   define NXPBUILD__PHHAL_HW_NCx3330
#endif
    ...
    || defined(PHDRIVER_FRDM_S32K118NCx3320_BOARD)
#   define NXPBUILD__PHHAL_HW_NCx3320
//#   define NXPBUILD__PHHAL_HW_NCx3320_CUSTOM_DEBUG
#endif
...
#define NXPBUILD__PHAC_DISCLOOP_SW                          /**< Discovery Loop Activity SW Component is included. */
    ...
    #ifndef NXPBUILD__PHHAL_HW_NCx3320
