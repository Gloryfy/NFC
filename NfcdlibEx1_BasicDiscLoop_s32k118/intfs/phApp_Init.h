...
#if defined(PHDRIVER_FRDM_K82FNCx3330_BOARD) || defined(PHDRIVER_FRDM_K82FNCx3320_BOARD)
#define PHDRIVER_KINETIS_K82
#endif

/* Check for LPC1769 controller based boards. */
#if defined(PHDRIVER_LPC1769NCx3330_BOARD) || defined(PHDRIVER_LPC1769NCx3320_BOARD)
#define PHDRIVER_LPC1769
#endif

/* Check for S32K14x controller based boards */
#if defined(PHDRIVER_FRDM_S32K144NCx3320_BOARD)
#define PHDRIVER_S32K14x
#endif

/* Check for S32K116 controller based boards */
#if defined(PHDRIVER_FRDM_S32K118NCx3320_BOARD)
#define PHDRIVER_S32K116
#endif

#if defined(PHDRIVER_PINCx3330_BOARD) || defined(PHDRIVER_PINCx3320_BOARD)
...
#else /* DEBUG */
#ifdef NODEBUG_PRINTF
#include "printf.h"  // kai 2020.12.30
    #define  DEBUG_PRINTF(...) printf(__VA_ARGS__);  // kai 2020.12.30
#else               // kai 2020.12.30
    #define  DEBUG_PRINTF(...)   // kai 2020.12.30
#endif             // kai 2020.12.30
#endif /* DEBUG */
...
#define PH_NFCRDLIB_EXAMPLE_LPCD_GUARDTIME      100           /* LPCD Guard time(T4) in milli-seconds ms configured by application for Ncx3320. */
#define PH_NFCRDLIB_EXAMPLE_LPCD_RFON_TIME      50            /* LPCD RFON time(T3) in micro-seconds us configured by application for Ncx3320. */
...
extern phhalHw_Ncx3330_DataParams_t   * pHal;
#endif

#ifdef NXPBUILD__PHHAL_HW_NCx3320
extern phhalHw_Ncx3320_DataParams_t    * pHal;
#endif
...
extern phStatus_t phApp_Configure_LED(uint8_t led, uint8_t state);
#endif /* PHAPP_INIT_H */
